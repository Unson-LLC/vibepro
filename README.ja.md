...
VibePro は現在 internal beta です。まだ public npm registry に存在しない場合、`npm install -D vibepro` や `pnpm add -D vibepro` を実行しても npm からは解決できません。
...
# GitHubアクセス権がある場合、internal betaとしてinstallする
