...
VibeProはアプリケーションコードを実装せず、証跡の十分性を認定せず、PRを承認せず、コードをmergeしません。最小コアにはGate DAG、blocking readiness判定、managed execution controller、review lifecycle会計、delivery-efficiency budget、自動audit bundleがありません。
