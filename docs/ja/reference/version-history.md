...
| --- | --- | --- |
| npm `latest` | `0.2.0-beta.2` | release workflow完了後の公開registry state |
| npm `beta` | `0.2.0-beta.2` | release workflow完了後の公開registry state |
| Repository `main` | `0.2.0-beta.2` のrelease source | Git commitと `CHANGELOG.md` |
