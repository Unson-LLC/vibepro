...
| --- | --- | --- |
| npm `latest` | `0.2.0-beta.19` | liveなnpm registry dist-tag |
| npm `beta` | `0.2.0-beta.19` | liveなnpm registry dist-tag |
| Repository `main` | `0.2.0-beta.19` release source | Git commitと `package.json` |
