...
- A read error or malformed JSONL row makes attribution unavailable with a bounded
  reason. The detector never reports a complete partition from a partial parse.
