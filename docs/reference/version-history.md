...
| --- | --- | --- |
| npm `latest` | `0.2.0-beta.23` | Live npm registry dist-tag |
| npm `beta` | `0.2.0-beta.23` | Live npm registry dist-tag |
| Repository `main` | `0.2.0-beta.23` release source | Git commit and `package.json` |
