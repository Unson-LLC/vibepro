...
- Completed judgments are filtered before host spawn and merged back after completion. Surface changes invalidate only judgments whose declared paths intersect changed paths.
