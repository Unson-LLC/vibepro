...
| Story | Story単位のStory Engineering Playbook形式ドキュメント出力 |
| Story ID | story-vibepro-story-scoped-playbook-export |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0196 (154 edges) | 14(file: 1, node: 68, edge: 154) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
