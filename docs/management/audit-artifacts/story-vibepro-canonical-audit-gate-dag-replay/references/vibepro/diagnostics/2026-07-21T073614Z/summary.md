...
| Story | Summary depthのCanonical Audit Replayを欠損なく引き継ぐ |
| Story ID | story-vibepro-canonical-audit-gate-dag-replay |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=dee040d3a307 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4762 |
| graphify edges | 10708 |
| 共通スキャン対象 | 5664件 |
...
- before: 2026-07-21T073251Z / after: 2026-07-21T073614Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0206 (221 edges) | 15(file: 1, node: 92, edge: 221) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
