...
- Story: story-vibepro-skills-claude-md-refresh
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 3
- Current head: cbb2c3ab2eadf2a2db46f3f3114ba4b4450e571e
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_a2d4e31be2461b64a87030eafb9b517b
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:2fb499533238347ad7dcce19f483e2bf15c662cd3e0b0e1319f00cc995267f52
- current_verification_summary_fingerprint: sha256:1a03ebd7e4e57db28864142364e4f819e0811746e1544898da1422f90d811643
- verification_evidence_updated_at: 2026-07-10T03:50:04.215Z
- current_verification_evidence_updated_at: 2026-07-10T04:08:09.534Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-10T03:50:04.214Z git_recorded_at=2026-07-10T03:50:04.185Z
- typecheck: executed_at=2026-07-10T03:50:00.868Z git_recorded_at=2026-07-10T03:50:00.841Z
- unit: executed_at=2026-07-10T03:49:57.746Z git_recorded_at=2026-07-10T03:49:57.715Z

現在のverification command timestamps:
- integration: executed_at=2026-07-10T04:08:09.534Z git_recorded_at=2026-07-10T04:08:09.504Z
- typecheck: executed_at=2026-07-10T04:08:05.807Z git_recorded_at=2026-07-10T04:08:05.773Z
- unit: executed_at=2026-07-10T04:08:01.823Z git_recorded_at=2026-07-10T04:08:01.781Z

Stale reasons:
- head_sha: head_sha changed previous=1780d82ffca9180fca07262d9de336497e3b83d8 current=94354979f0dc753f6779fbafd27a031ba78d2f64
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:43fd1e47f7d09ced713b5e11baea48d85e04225a0cc2343c945ed9cfd4b24576 current=sha256:2fb499533238347ad7dcce19f483e2bf15c662cd3e0b0e1319f00cc995267f52
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-10T03:46:39.524Z current=2026-07-10T03:50:04.215Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"integration","executed_at":"2026-07-10T03:46:39.524Z","git_recorded_at":"2026-07-10T03:46:39.494Z"},{"kind":"typecheck","executed_at":"2026-07-10T03:46:36.752Z","git_recorded_at":"2026-07-10T03:46:36.724Z"},{"kind":"unit","executed_at":"2026-07-10T03:46:33.820Z","git_recorded_at":"2026-07-10T03:46:33.788Z"}] current=[{"kind":"integration","executed_at":"2026-07-10T03:50:04.214Z","git_recorded_at":"2026-07-10T03:50:04.185Z"},{"kind":"typecheck","executed_at":"2026-07-10T03:50:00.868Z","git_recorded_at":"2026-07-10T03:50:00.841Z"},{"kind":"unit","executed_at":"2026-07-10T03:49:57.746Z","git_recorded_at":"2026-07-10T03:49:57.715Z"}]
- head_sha: review prepare current HEAD does not match evidence key HEAD previous=94354979f0dc753f6779fbafd27a031ba78d2f64 current=cbb2c3ab2eadf2a2db46f3f3114ba4b4450e571e
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-skills-claude-md-refresh --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-skills-claude-md-refresh --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-skills-claude-md-refresh/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-skills-claude-md-refresh/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-skills-claude-md-refresh/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-skills-claude-md-refresh/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-skills-claude-md-refresh --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-skills-claude-md-refresh --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-skills-claude-md-refresh --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-skills-claude-md-refresh/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-skills-claude-md-refresh --stage gate --role pr_split_scope --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-skills-claude-md-refresh --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-skills-claude-md-refresh --stage gate --role pr_split_scope --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-skills-claude-md-refresh/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-skills-claude-md-refresh --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-skills-claude-md-refresh --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-skills-claude-md-refresh --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
