...
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=802eb00228b5 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 5270 |
| graphify edges | 11771 |
| 共通スキャン対象 | 7208件 |
...
- before: 2026-07-23T212922Z / after: 2026-07-24T013903Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0234 (275 edges) | 15(file: 1, node: 111, edge: 275) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
