...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-07T102819Z |
| Story | dogfood で学習した非自明レシピを autopilot preflight として製品に吸収する |
| Story ID | story-vibepro-recipe-preflight-autopilot |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=d0b8662f68b0 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0209 (179 edges) | 13(file: 1, node: 79, edge: 179) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
