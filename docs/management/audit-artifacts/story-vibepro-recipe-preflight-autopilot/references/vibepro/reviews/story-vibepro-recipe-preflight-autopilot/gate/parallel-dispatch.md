...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-recipe-preflight-autopilot --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-recipe-preflight-autopilot --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-recipe-preflight-autopilot/gate/review-request-gate_evidence.md`
...
`vibepro review start . --id story-vibepro-recipe-preflight-autopilot --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-recipe-preflight-autopilot --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-recipe-preflight-autopilot/gate/review-request-release_risk.md`
...
Lifecycle start command:
`vibepro review start . --id story-vibepro-recipe-preflight-autopilot --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-recipe-preflight-autopilot --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
