...
- status: stale
- evidence_key: evk_7a1358ef0f523604e76023f29b779ebc
- first_input: false
...
Stale reasons:
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:6411c4a78e87229c4f098820a26769bbe9772f2d73b884ebe7f1842488499eea current=sha256:43cdeb558ac91a0c56f34a956ae3c393cf0d039d5485229e339655c7a3b0d545
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-managed-worktree-policy-resync --stage preview` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-managed-worktree-policy-resync --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-managed-worktree-policy-resync/preview/review-request-network_runtime.md`
...
`vibepro review start . --id story-vibepro-managed-worktree-policy-resync --stage preview --role network_runtime --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-managed-worktree-policy-resync --stage preview --role network_runtime --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-managed-worktree-policy-resync/preview/review-request-human_usability.md`
...
Lifecycle start command:
`vibepro review start . --id story-vibepro-managed-worktree-policy-resync --stage preview --role human_usability --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-managed-worktree-policy-resync --stage preview --role human_usability --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
