...
- Current head: 78982951496abee40e54e05001139098241e3f8a
- User dirty: false
- Raw dirty: true
...
- status: stale
- evidence_key: evk_b2977b12a09900a6d13ab7da92d98403
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:75691db532bb1268281902ca3800795acfa7e7fb6828b7f87c02d995a82f40c3
- current_verification_summary_fingerprint: sha256:75691db532bb1268281902ca3800795acfa7e7fb6828b7f87c02d995a82f40c3
- verification_evidence_updated_at: 2026-07-21T15:09:46.614Z
- current_verification_evidence_updated_at: 2026-07-21T15:09:46.614Z
- preferred_order: -

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-21T15:09:46.614Z git_recorded_at=2026-07-21T15:09:46.515Z
- unit: executed_at=2026-07-21T15:09:33.505Z git_recorded_at=2026-07-21T15:09:33.327Z
...
Stale reasons:
- head_sha: head_sha changed previous=fed325a0a126a393fd1cec7f4b1eb9acd6af7bad current=78982951496abee40e54e05001139098241e3f8a
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:12a5d8770914a39b3c8ada818cc312d66374010186fc5ae7e4729eadef8edb2a current=sha256:75691db532bb1268281902ca3800795acfa7e7fb6828b7f87c02d995a82f40c3
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-21T14:38:01.928Z current=2026-07-21T15:09:46.614Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"unit","executed_at":"2026-07-21T14:38:01.927Z","git_recorded_at":"2026-07-21T14:38:01.875Z"},{"kind":"e2e","executed_at":"2026-07-21T14:37:01.723Z","git_recorded_at":"2026-07-21T14:37:01.675Z"}] current=[{"kind":"e2e","executed_at":"2026-07-21T15:09:46.614Z","git_recorded_at":"2026-07-21T15:09:46.515Z"},{"kind":"unit","executed_at":"2026-07-21T15:09:33.505Z","git_recorded_at":"2026-07-21T15:09:33.327Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:55f091d74aa3f0c521198bcb05d949b461c214ce9aaa6d3fe9a238a7d759e182 current=sha256:6411c4a78e87229c4f098820a26769bbe9772f2d73b884ebe7f1842488499eea
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-managed-worktree-policy-resync --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-managed-worktree-policy-resync --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-managed-worktree-policy-resync/implementation/review-request-runtime_contract.md`
...
`vibepro review start . --id story-vibepro-managed-worktree-policy-resync --stage implementation --role runtime_contract --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-managed-worktree-policy-resync --stage implementation --role runtime_contract --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-managed-worktree-policy-resync/implementation/review-request-ux_completion.md`
...
Lifecycle start command:
`vibepro review start . --id story-vibepro-managed-worktree-policy-resync --stage implementation --role ux_completion --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-managed-worktree-policy-resync --stage implementation --role ux_completion --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
