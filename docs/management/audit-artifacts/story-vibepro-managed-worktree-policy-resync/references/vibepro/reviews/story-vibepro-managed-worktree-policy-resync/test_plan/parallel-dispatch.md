...
- Current head: fed325a0a126a393fd1cec7f4b1eb9acd6af7bad
- User dirty: false
- Raw dirty: true
...
- status: stale
- evidence_key: evk_04f1c24c990b7505211460c019935f2b
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:12a5d8770914a39b3c8ada818cc312d66374010186fc5ae7e4729eadef8edb2a
- current_verification_summary_fingerprint: sha256:12a5d8770914a39b3c8ada818cc312d66374010186fc5ae7e4729eadef8edb2a
- verification_evidence_updated_at: 2026-07-21T14:38:01.928Z
- current_verification_evidence_updated_at: 2026-07-21T14:38:01.928Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-21T14:38:01.927Z git_recorded_at=2026-07-21T14:38:01.875Z
- e2e: executed_at=2026-07-21T14:37:01.723Z git_recorded_at=2026-07-21T14:37:01.675Z
...
Stale reasons:
- head_sha: head_sha changed previous=b0b55e7a6c8b72d3c722edea961d493c87df7f06 current=fed325a0a126a393fd1cec7f4b1eb9acd6af7bad
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:e7a7d6df1ae5377f38381cfa9fdacb93db1dcffbc1ba47d214cd65b180a88790 current=sha256:12a5d8770914a39b3c8ada818cc312d66374010186fc5ae7e4729eadef8edb2a
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-21T14:04:55.261Z current=2026-07-21T14:38:01.928Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"e2e","executed_at":"2026-07-21T14:04:55.261Z","git_recorded_at":"2026-07-21T14:04:55.221Z"},{"kind":"unit","executed_at":"2026-07-21T14:04:51.471Z","git_recorded_at":"2026-07-21T14:04:51.425Z"}] current=[{"kind":"unit","executed_at":"2026-07-21T14:38:01.927Z","git_recorded_at":"2026-07-21T14:38:01.875Z"},{"kind":"e2e","executed_at":"2026-07-21T14:37:01.723Z","git_recorded_at":"2026-07-21T14:37:01.675Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:a2d29927376d03e6c19815a0c43b220bd4f710428d60e72bad969e88017091f0 current=sha256:55f091d74aa3f0c521198bcb05d949b461c214ce9aaa6d3fe9a238a7d759e182
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-managed-worktree-policy-resync --stage test_plan` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-managed-worktree-policy-resync --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-managed-worktree-policy-resync/test_plan/review-request-e2e_ux.md`
...
`vibepro review start . --id story-vibepro-managed-worktree-policy-resync --stage test_plan --role e2e_ux --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-managed-worktree-policy-resync --stage test_plan --role e2e_ux --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-managed-worktree-policy-resync/test_plan/review-request-gate_coverage.md`
...
Lifecycle start command:
`vibepro review start . --id story-vibepro-managed-worktree-policy-resync --stage test_plan --role gate_coverage --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-managed-worktree-policy-resync --stage test_plan --role gate_coverage --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
