...
| Story | Managed worktreeのポリシーconfigを凍結させず親repoから再同期する |
| Story ID | story-vibepro-managed-worktree-policy-resync |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=0a91f01a1a9e dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4870 |
| graphify edges | 10970 |
| 共通スキャン対象 | 5966件 |
