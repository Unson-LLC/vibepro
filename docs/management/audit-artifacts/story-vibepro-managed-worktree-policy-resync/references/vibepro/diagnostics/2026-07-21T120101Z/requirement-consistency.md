...
- REQ-INV-001: MWPR-S-2: 非ポリシーセクション（brainbase story catalog等）は再同期対象外で、worktree作成時のスナップショットのまま維持される。 (story:docs/management/stories/active/story-vibepro-managed-worktree-policy-resync.md)
