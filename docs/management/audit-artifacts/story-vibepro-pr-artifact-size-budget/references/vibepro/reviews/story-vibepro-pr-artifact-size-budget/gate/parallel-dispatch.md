...
- Story: story-vibepro-pr-artifact-size-budget
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 3
- Current head: ce69fd781574d8e6cc19b9752bbdee97543fc858
- User dirty: false
- Raw dirty: false
...
- status: fresh
- evidence_key: evk_86d1d02346f6f8e72ed8a66ba927775e
- first_input: true
- reason: Fresh evidence summary/index can be used as first review input.
- verification_summary_fingerprint: sha256:95767eae3d60f47b2fc4ab36bc7855db43ab0faa64b8269b5fd16c1531a3af5a
- current_verification_summary_fingerprint: sha256:95767eae3d60f47b2fc4ab36bc7855db43ab0faa64b8269b5fd16c1531a3af5a
- verification_evidence_updated_at: 2026-07-07T10:23:52.860Z
- current_verification_evidence_updated_at: 2026-07-07T10:23:52.860Z
- preferred_order: .vibepro/pr/story-vibepro-pr-artifact-size-budget/evidence-reuse.json, .vibepro/pr/story-vibepro-pr-artifact-size-budget/decision-index.json, .vibepro/pr/story-vibepro-pr-artifact-size-budget/evidence-plan.json, .vibepro/pr/story-vibepro-pr-artifact-size-budget/pr-prepare.json, .vibepro/pr/story-vibepro-pr-artifact-size-budget/gate-dag.json

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-07T10:23:52.860Z git_recorded_at=2026-07-07T10:23:52.853Z
- integration: executed_at=2026-07-07T10:19:20.977Z git_recorded_at=2026-07-07T10:19:20.969Z
- unit: executed_at=2026-07-07T10:19:19.302Z git_recorded_at=2026-07-07T10:19:19.295Z
- typecheck: executed_at=2026-07-07T10:19:17.665Z git_recorded_at=2026-07-07T10:19:17.658Z
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-pr-artifact-size-budget --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-pr-artifact-size-budget --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-pr-artifact-size-budget/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-pr-artifact-size-budget/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-pr-artifact-size-budget/gate-dag.summary.json`（bounded summary。まずこれを読む）。full artifact `gate-dag.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-pr-artifact-size-budget/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-pr-artifact-size-budget --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-pr-artifact-size-budget --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-pr-artifact-size-budget --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-pr-artifact-size-budget/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-pr-artifact-size-budget --stage gate --role pr_split_scope --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-pr-artifact-size-budget --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-pr-artifact-size-budget --stage gate --role pr_split_scope --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-pr-artifact-size-budget/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-pr-artifact-size-budget --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-pr-artifact-size-budget --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-pr-artifact-size-budget --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
