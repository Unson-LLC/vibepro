...
| Story | pr prepare artifact に per-file サイズ予算を課し、LLM handoff は bounded summary を既定にする |
| Story ID | story-vibepro-pr-artifact-size-budget |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=ce69fd781574 dirty=false |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.021 (179 edges) | 14(file: 1, node: 79, edge: 179) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
