...
| Story | Story Engineering Playbookの必須テンプレをVibePro本体に同梱する |
| Story ID | story-vibepro-bundled-playbook-templates |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=8e858767de46 dirty=false |
| 種別 | unknown |
| 描画方式 | - |
...
| graphify edges | 7885 |
| 共通スキャン対象 | 1157件 |
| 秘密情報候補 | 71件 (block: 0件, review: 0件, info: 71件) |
| XSSリスク候補 | 33件 (block: 0件, review: 0件, info: 33件) |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0195 (154 edges) | 15(file: 1, node: 68, edge: 154) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
