...
| Story | Release noteのrepo-root docsリンクを公開docs rootへ正規化する |
| Story ID | story-vibepro-release-note-link-normalization |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=80f981820cb1 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0221 (221 edges) | 15(file: 1, node: 92, edge: 221) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
