...
| Story | レビュー中のレビュー面変更をappend-onlyの違反として型分離し再実行で消えない記録にする |
| Story ID | story-vibepro-review-surface-violation-ledger |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.2.0-beta.2 commit=ee0b6f795c58 dirty=false |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality, api-boundary |
| graphify nodes | 5747 |
| graphify edges | 12877 |
| 共通スキャン対象 | 8172件 |
...
- before: 2026-07-26T144947Z / after: 2026-07-29T084338Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0214 (275 edges) | 17(file: 1, node: 111, edge: 275) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
