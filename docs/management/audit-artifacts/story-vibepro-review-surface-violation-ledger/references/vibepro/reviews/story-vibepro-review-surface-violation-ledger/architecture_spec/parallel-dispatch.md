...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-review-surface-violation-ledger --stage architecture_spec` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-review-surface-violation-ledger --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-review-surface-violation-ledger/architecture_spec/review-request-architecture_boundary.md`
