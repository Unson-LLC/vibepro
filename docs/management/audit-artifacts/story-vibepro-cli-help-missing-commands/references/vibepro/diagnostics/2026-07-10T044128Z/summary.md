...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-10T044128Z |
| Story | CLI --help Usage must list runtime commands story map, task brief/plan/handoff, and check list |
| Story ID | story-vibepro-cli-help-missing-commands |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=96a4aab711a5 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0237 (214 edges) | 12(file: 1, node: 88, edge: 212), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
