...
- Story: story-vibepro-guarded-autonomy-hardening
- Stage: implementation
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: 1c7c362ad3f9c67aa918242763af840fe94ce334
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_3d44b0064fdfa728d879f6cb81990e89
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:edb420b3386f62a9eab7c8ae0e5f5f65f29db84bcb5220ac9a5308c6bd3222a9
- current_verification_summary_fingerprint: sha256:edb420b3386f62a9eab7c8ae0e5f5f65f29db84bcb5220ac9a5308c6bd3222a9
- verification_evidence_updated_at: 2026-07-21T06:13:12.532Z
- current_verification_evidence_updated_at: 2026-07-21T06:13:12.532Z
- preferred_order: -

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-21T06:13:12.532Z git_recorded_at=2026-07-21T06:13:12.515Z
- unit: executed_at=2026-07-21T05:54:56.345Z git_recorded_at=2026-07-21T05:54:56.334Z
...
Stale reasons:
- spec_fingerprint: spec_fingerprint changed previous=sha256:2f3efdef22f39743ac058fd62d873603f1d61372d16237f9d04beb3638fb91a6 current=sha256:72c175ad5d39992d8bf03dd11483b451b7eb45352c654a29813498495b31b56a
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:302bd4cccc385de6371bd374e5b5ce668cf178bcf662b198e9b947522dfd501d current=sha256:258c6496b78c6cb56ea9571e7fa67b2c484605fcb8b340b626b82287a35a1f4d
- head_sha: review prepare current HEAD does not match evidence key HEAD previous=e6f5cb0438c98309ef98e88a13c7263c59f01b9b current=1c7c362ad3f9c67aa918242763af840fe94ce334
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-guarded-autonomy-hardening --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-guarded-autonomy-hardening --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-guarded-autonomy-hardening/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-guarded-autonomy-hardening/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-guarded-autonomy-hardening/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-guarded-autonomy-hardening/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-guarded-autonomy-hardening/implementation/review-request-ux_completion.md`
...
`vibepro review record . --id story-vibepro-guarded-autonomy-hardening --stage implementation --role ux_completion --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-guarded-autonomy-hardening --stage implementation --role ux_completion --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-guarded-autonomy-hardening --stage implementation --role ux_completion --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
