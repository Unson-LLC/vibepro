...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-23T235311Z |
| Story | Delivery事実と再調整状態を分離する |
| Story ID | story-vibepro-delivery-reconciliation-state |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=55bcd400626c dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality, api-boundary |
| graphify nodes | 5312 |
| graphify edges | 11933 |
| 共通スキャン対象 | 7214件 |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.023 (275 edges) | 13(file: 1, node: 110, edge: 273), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
