...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-05T124505Z |
| Story | Keyword Gate Structured Migration |
| Story ID | story-vibepro-keyword-gate-structured-migration |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=8b91e3fce07f dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0214 (179 edges) | 14(file: 1, node: 79, edge: 179) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
