...
- status: stale
- evidence_key: evk_7ca819890e7bc2cbc11b6e2150b73fad
- first_input: false
...
Stale reasons:
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:47130274cf860c60d93586c9bb20cee1bb64f50fd7e8882b3edae9eddd0cdde9 current=sha256:86381dde3be77e78d0beba2557c6f8e47e1bd623f42e58993798d3af7080d241
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-30T18:21:47.812Z current=2026-07-30T18:24:09.799Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"e2e","executed_at":"2026-07-30T18:21:47.143Z","git_recorded_at":"2026-07-30T18:21:47.800Z"},{"kind":"unit","executed_at":"2026-07-30T18:18:49.674Z","git_recorded_at":"2026-07-30T18:18:50.312Z"},{"kind":"integration","executed_at":"2026-07-30T18:15:13.474Z","git_recorded_at":"2026-07-30T18:15:14.236Z"},{"kind":"build","executed_at":"2026-07-30T18:10:15.257Z","git_recorded_at":"2026-07-30T18:10:15.821Z"},{"kind":"typecheck","executed_at":"2026-07-30T18:10:10.528Z","git_recorded_at":"2026-07-30T18:10:11.058Z"}] current=[{"kind":"unit","executed_at":"2026-07-30T18:24:09.179Z","git_recorded_at":"2026-07-30T18:24:09.781Z"},{"kind":"e2e","executed_at":"2026-07-30T18:21:47.143Z","git_recorded_at":"2026-07-30T18:21:47.800Z"},{"kind":"integration","executed_at":"2026-07-30T18:15:13.474Z","git_recorded_at":"2026-07-30T18:15:14.236Z"},{"kind":"build","executed_at":"2026-07-30T18:10:15.257Z","git_recorded_at":"2026-07-30T18:10:15.821Z"},{"kind":"typecheck","executed_at":"2026-07-30T18:10:10.528Z","git_recorded_at":"2026-07-30T18:10:11.058Z"}]
...
- digest: d07c92982c7eef6cfb5b2953ecfc4d36d7a37eb45f86c9e4d105022e0f2120f5
- total: 10
- returned: 10
- omitted: 0
- truncated: false
...
- partial decision_trace_id=dt_76443edb18ac578e27f56318b2203c6236cff941976d526baf13a18e75e285c5 parent_revision=7c8911332fd19379e8540a4e9762454976082c2234aa9ef3ef1a0811b9186b46 chain={"finding":{"id":"gate-evidence-final-synthesis-stale","severity":"high"},"disposition":null,"decision":null,"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
- partial decision_trace_id=dt_886dcd7580186341763898f1a2400efed87d25fca0aec4d803ae59c1adc195a8 parent_revision=70680c1eaf6dd86cb92e5e82b3b0196aa13420f1bf7c0f2db67b0d4995e11cc6 chain={"finding":null,"disposition":null,"decision":{},"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-task-atomic-repo-control-contract --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-task-atomic-repo-control-contract --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-task-atomic-repo-control-contract/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-task-atomic-repo-control-contract --stage gate --role gate_evidence --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-task-atomic-repo-control-contract --stage gate --role gate_evidence --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-task-atomic-repo-control-contract --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-task-atomic-repo-control-contract --stage gate --role gate_evidence --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
