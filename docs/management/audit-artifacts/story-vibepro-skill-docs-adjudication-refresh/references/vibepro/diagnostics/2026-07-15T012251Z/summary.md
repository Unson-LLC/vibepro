...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-15T012251Z |
| Story | gate進化（adjudication・inconclusive・release guard）をagent Skillsへ反映する |
| Story ID | story-vibepro-skill-docs-adjudication-refresh |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=0cc037102b40 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0237 (220 edges) | 12(file: 1, node: 91, edge: 218), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
