...
- Story: story-vibepro-progress-heartbeat-policy-kernel
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: 19859ffbf4ebd03bf77f991cfcf51324cd7cc7f3
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_6e02d14a0b6ab08a8d9b537b5da24c52
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:07615eae9ef48fef18cc92a139bbb82c55ca6ed609dbad00ee5104f4d01ddc17
- current_verification_summary_fingerprint: sha256:f100c4f2db92d337975ba7095ee1ad0454feb63f406f235bb638ae9f326d3041
- verification_evidence_updated_at: 2026-08-04T03:05:31.715Z
- current_verification_evidence_updated_at: 2026-08-04T03:51:19.603Z
- preferred_order: -

Reuse key内のverification command timestamps:
- typecheck: executed_at=2026-08-04T03:05:30.884Z git_recorded_at=2026-08-04T03:05:31.697Z
- integration: executed_at=2026-08-04T03:05:16.142Z git_recorded_at=2026-08-04T03:05:16.899Z
- e2e: executed_at=2026-08-04T03:05:05.202Z git_recorded_at=2026-08-04T03:05:05.939Z
- unit: executed_at=2026-08-04T03:04:26.347Z git_recorded_at=2026-08-04T03:04:27.186Z

現在のverification command timestamps:
- typecheck: executed_at=2026-08-04T03:51:18.952Z git_recorded_at=2026-08-04T03:51:19.586Z
- integration: executed_at=2026-08-04T03:51:05.523Z git_recorded_at=2026-08-04T03:51:06.197Z
- e2e: executed_at=2026-08-04T03:50:55.790Z git_recorded_at=2026-08-04T03:50:56.442Z
- unit: executed_at=2026-08-04T03:50:31.982Z git_recorded_at=2026-08-04T03:50:32.985Z

Stale reasons:
- head_sha: review prepare current HEAD does not match evidence key HEAD previous=59d172b1687df0a691de761d145f89558828e336 current=19859ffbf4ebd03bf77f991cfcf51324cd7cc7f3
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:07615eae9ef48fef18cc92a139bbb82c55ca6ed609dbad00ee5104f4d01ddc17 current=sha256:f100c4f2db92d337975ba7095ee1ad0454feb63f406f235bb638ae9f326d3041
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-08-04T03:05:31.715Z current=2026-08-04T03:51:19.603Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"typecheck","executed_at":"2026-08-04T03:05:30.884Z","git_recorded_at":"2026-08-04T03:05:31.697Z"},{"kind":"integration","executed_at":"2026-08-04T03:05:16.142Z","git_recorded_at":"2026-08-04T03:05:16.899Z"},{"kind":"e2e","executed_at":"2026-08-04T03:05:05.202Z","git_recorded_at":"2026-08-04T03:05:05.939Z"},{"kind":"unit","executed_at":"2026-08-04T03:04:26.347Z","git_recorded_at":"2026-08-04T03:04:27.186Z"}] current=[{"kind":"typecheck","executed_at":"2026-08-04T03:51:18.952Z","git_recorded_at":"2026-08-04T03:51:19.586Z"},{"kind":"integration","executed_at":"2026-08-04T03:51:05.523Z","git_recorded_at":"2026-08-04T03:51:06.197Z"},{"kind":"e2e","executed_at":"2026-08-04T03:50:55.790Z","git_recorded_at":"2026-08-04T03:50:56.442Z"},{"kind":"unit","executed_at":"2026-08-04T03:50:31.982Z","git_recorded_at":"2026-08-04T03:50:32.985Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-progress-heartbeat-policy-kernel --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-progress-heartbeat-policy-kernel --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-progress-heartbeat-policy-kernel/evidence-reuse.summary.json`（bounded summary。まずこれを読む）。full artifact `evidence-reuse.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-progress-heartbeat-policy-kernel/evidence-plan.summary.json`（bounded summary。まずこれを読む）。full artifact `evidence-plan.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-progress-heartbeat-policy-kernel/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-progress-heartbeat-policy-kernel/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-progress-heartbeat-policy-kernel/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-progress-heartbeat-policy-kernel/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-progress-heartbeat-policy-kernel/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-progress-heartbeat-policy-kernel/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-progress-heartbeat-policy-kernel --stage gate --role gate_evidence --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-progress-heartbeat-policy-kernel --stage gate --role gate_evidence --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-progress-heartbeat-policy-kernel --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-progress-heartbeat-policy-kernel --stage gate --role gate_evidence --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
