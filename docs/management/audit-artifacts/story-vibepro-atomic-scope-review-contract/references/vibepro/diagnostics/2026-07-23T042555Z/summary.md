...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-23T042555Z |
| Story | atomic単一PRを現HEADのreview ownershipと検証証跡でfail-closedに裁定する |
| Story ID | story-vibepro-atomic-scope-review-contract |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=c58152d52f09 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 5077 |
| graphify edges | 11416 |
| 共通スキャン対象 | 6910件 |
...
- before: 2026-07-23T034609Z / after: 2026-07-23T042555Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0241 (275 edges) | 14(file: 1, node: 111, edge: 275) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
