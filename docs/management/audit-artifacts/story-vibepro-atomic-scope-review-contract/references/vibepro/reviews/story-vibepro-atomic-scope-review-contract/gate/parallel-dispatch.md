...
- status: stale
- evidence_key: evk_ccc011eefd1514b2c3f3b5d079130317
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:1714ace2cb2fa1269849b738b6ac17a35c463a7a89127e774303f97a8d8030bb
- current_verification_summary_fingerprint: sha256:1714ace2cb2fa1269849b738b6ac17a35c463a7a89127e774303f97a8d8030bb
- verification_evidence_updated_at: 2026-07-23T11:18:49.170Z
- current_verification_evidence_updated_at: 2026-07-23T11:18:49.170Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-23T11:18:49.170Z git_recorded_at=2026-07-23T11:18:49.144Z
...
Stale reasons:
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:dd3c302080fbe7e37764d64de6b8b9dfae5d1ca7de9ab149d31c38345f3e7487 current=sha256:1714ace2cb2fa1269849b738b6ac17a35c463a7a89127e774303f97a8d8030bb
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-23T11:07:10.273Z current=2026-07-23T11:18:49.170Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"unit","executed_at":"2026-07-23T11:07:10.273Z","git_recorded_at":"2026-07-23T11:07:10.260Z"},{"kind":"e2e","executed_at":"2026-07-23T10:47:15.598Z","git_recorded_at":"2026-07-23T10:47:15.534Z"},{"kind":"integration","executed_at":"2026-07-23T10:23:19.141Z","git_recorded_at":"2026-07-23T10:23:19.139Z"},{"kind":"build","executed_at":"2026-07-23T10:17:21.792Z","git_recorded_at":"2026-07-23T10:17:21.776Z"},{"kind":"typecheck","executed_at":"2026-07-23T10:17:20.870Z","git_recorded_at":"2026-07-23T10:17:20.851Z"}] current=[{"kind":"unit","executed_at":"2026-07-23T11:18:49.170Z","git_recorded_at":"2026-07-23T11:18:49.144Z"},{"kind":"e2e","executed_at":"2026-07-23T10:47:15.598Z","git_recorded_at":"2026-07-23T10:47:15.534Z"},{"kind":"integration","executed_at":"2026-07-23T10:23:19.141Z","git_recorded_at":"2026-07-23T10:23:19.139Z"},{"kind":"build","executed_at":"2026-07-23T10:17:21.792Z","git_recorded_at":"2026-07-23T10:17:21.776Z"},{"kind":"typecheck","executed_at":"2026-07-23T10:17:20.870Z","git_recorded_at":"2026-07-23T10:17:20.851Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:501b79a436bf075246afd484839ce56eadc60ecd87b7695221b8ba02535d3643 current=sha256:10831f334c79364105d634e49225ec7d4237a6cf740423748aff94cee027ffbd
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-atomic-scope-review-contract --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-atomic-scope-review-contract --base <base-branch>` で次stageへ進む。
...
## Subagent 1: gate:release_risk

Review request:
`.vibepro/reviews/story-vibepro-atomic-scope-review-contract/gate/review-request-release_risk.md`
...
`vibepro review record . --id story-vibepro-atomic-scope-review-contract --stage gate --role release_risk --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-atomic-scope-review-contract --stage gate --role release_risk --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-atomic-scope-review-contract --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-atomic-scope-review-contract --stage gate --role release_risk --agent-id "<replacement-agent-id>" --close-reason "<completed|timeout|replaced|manual_shutdown>" --close-evidence "<replacement-agent-close-evidence>"`
