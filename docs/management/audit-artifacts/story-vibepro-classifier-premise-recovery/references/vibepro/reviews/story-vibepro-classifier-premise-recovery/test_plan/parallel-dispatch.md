...
- Story: story-vibepro-classifier-premise-recovery
- Stage: test_plan
- Mode: policy-aware parallel review dispatch
- Required subagents: 3
- Current head: 6581d33016632f9921b278d473e6c71fb96c4c94
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_f3434053ea99012895b1023a18a758aa
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:05ef662c37830ee8f31c234f81b40db3c75ab5ccd6e964c19e7a355a8a88b513
- current_verification_summary_fingerprint: sha256:05ef662c37830ee8f31c234f81b40db3c75ab5ccd6e964c19e7a355a8a88b513
- verification_evidence_updated_at: 2026-07-18T17:19:59.810Z
- current_verification_evidence_updated_at: 2026-07-18T17:19:59.810Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-18T17:19:59.810Z git_recorded_at=2026-07-18T17:19:59.797Z
- integration: executed_at=2026-07-18T17:17:53.552Z git_recorded_at=2026-07-18T17:17:53.543Z
- build: executed_at=2026-07-18T17:17:30.101Z git_recorded_at=2026-07-18T17:17:30.098Z
- e2e: executed_at=2026-07-18T17:16:57.284Z git_recorded_at=2026-07-18T17:16:57.273Z
- typecheck: executed_at=2026-07-18T17:13:41.995Z git_recorded_at=2026-07-18T17:13:41.994Z
...
Stale reasons:
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:526d03998a1f78672704f0fdae93d23eaae35d75bc9ae9307d87928fa9caebe3 current=sha256:bb8834200811fdbe071c2e5dbe7f192c233226bb9d0626b3fcfcfcb4c3a44630
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-classifier-premise-recovery --stage test_plan` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-classifier-premise-recovery --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-classifier-premise-recovery/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-classifier-premise-recovery/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-classifier-premise-recovery/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-classifier-premise-recovery/test_plan/review-request-unit_integration.md`
...
Review request:
`.vibepro/reviews/story-vibepro-classifier-premise-recovery/test_plan/review-request-e2e_ux.md`
...
Lifecycle start command:
`vibepro review start . --id story-vibepro-classifier-premise-recovery --stage test_plan --role e2e_ux --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-classifier-premise-recovery --stage test_plan --role e2e_ux --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-classifier-premise-recovery/test_plan/review-request-gate_coverage.md`
...
Lifecycle start command:
`vibepro review start . --id story-vibepro-classifier-premise-recovery --stage test_plan --role gate_coverage --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-classifier-premise-recovery --stage test_plan --role gate_coverage --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
