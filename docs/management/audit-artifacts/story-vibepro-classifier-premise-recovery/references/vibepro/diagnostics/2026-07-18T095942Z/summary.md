...
| VibePro Runtime | vibepro@0.2.0-beta.0 commit=fe84fd18b04f dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
- before: 2026-07-18T093150Z / after: 2026-07-18T095942Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0226 (221 edges) | 13(file: 1, node: 92, edge: 221) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
