...
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=a5f9127d64c3 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0237 (214 edges) | 13(file: 1, node: 88, edge: 212), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
