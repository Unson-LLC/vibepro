...
- Current head: 4cc07d8ef2301b2e3e36da0fd93d146338ea1d8b
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_db6d81ad294b7abf27c2925a961e217f
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:9866538e914e17b982d6af3e855b87a8ed36e095e3f7f1350389e7ae1a6a2cf5
- current_verification_summary_fingerprint: sha256:d1119d9d162d6905f0cd2bdc63c588a840a0286cf88482d76c062b2feeaed2a2
- verification_evidence_updated_at: 2026-07-21T11:32:23.103Z
- current_verification_evidence_updated_at: 2026-07-21T11:49:12.509Z
- preferred_order: -

Reuse key内のverification command timestamps:
- typecheck: executed_at=2026-07-21T11:32:23.103Z git_recorded_at=2026-07-21T11:32:23.052Z
- e2e: executed_at=2026-07-21T11:32:11.718Z git_recorded_at=2026-07-21T11:32:11.689Z
- integration: executed_at=2026-07-21T11:31:59.706Z git_recorded_at=2026-07-21T11:31:59.502Z
- unit: executed_at=2026-07-21T11:31:51.469Z git_recorded_at=2026-07-21T11:31:51.358Z

現在のverification command timestamps:
- e2e: executed_at=2026-07-21T11:49:12.509Z git_recorded_at=2026-07-21T11:49:12.278Z
- integration: executed_at=2026-07-21T11:48:45.938Z git_recorded_at=2026-07-21T11:48:45.370Z
- typecheck: executed_at=2026-07-21T11:32:23.103Z git_recorded_at=2026-07-21T11:32:23.052Z
- unit: executed_at=2026-07-21T11:31:51.469Z git_recorded_at=2026-07-21T11:31:51.358Z

Stale reasons:
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:9866538e914e17b982d6af3e855b87a8ed36e095e3f7f1350389e7ae1a6a2cf5 current=sha256:d1119d9d162d6905f0cd2bdc63c588a840a0286cf88482d76c062b2feeaed2a2
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-07-21T11:32:23.103Z current=2026-07-21T11:49:12.509Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"typecheck","executed_at":"2026-07-21T11:32:23.103Z","git_recorded_at":"2026-07-21T11:32:23.052Z"},{"kind":"e2e","executed_at":"2026-07-21T11:32:11.718Z","git_recorded_at":"2026-07-21T11:32:11.689Z"},{"kind":"integration","executed_at":"2026-07-21T11:31:59.706Z","git_recorded_at":"2026-07-21T11:31:59.502Z"},{"kind":"unit","executed_at":"2026-07-21T11:31:51.469Z","git_recorded_at":"2026-07-21T11:31:51.358Z"}] current=[{"kind":"e2e","executed_at":"2026-07-21T11:49:12.509Z","git_recorded_at":"2026-07-21T11:49:12.278Z"},{"kind":"integration","executed_at":"2026-07-21T11:48:45.938Z","git_recorded_at":"2026-07-21T11:48:45.370Z"},{"kind":"typecheck","executed_at":"2026-07-21T11:32:23.103Z","git_recorded_at":"2026-07-21T11:32:23.052Z"},{"kind":"unit","executed_at":"2026-07-21T11:31:51.469Z","git_recorded_at":"2026-07-21T11:31:51.358Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-explicit-run-attribution-lineage --stage test_plan` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-explicit-run-attribution-lineage --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-explicit-run-attribution-lineage/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-explicit-run-attribution-lineage/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-explicit-run-attribution-lineage/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-explicit-run-attribution-lineage/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-explicit-run-attribution-lineage/test_plan/review-request-e2e_ux.md`
...
`vibepro review record . --id story-vibepro-explicit-run-attribution-lineage --stage test_plan --role e2e_ux --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-explicit-run-attribution-lineage --stage test_plan --role e2e_ux --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-explicit-run-attribution-lineage --stage test_plan --role e2e_ux --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-explicit-run-attribution-lineage/test_plan/review-request-gate_coverage.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-explicit-run-attribution-lineage --stage test_plan --role gate_coverage --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-explicit-run-attribution-lineage --stage test_plan --role gate_coverage --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-explicit-run-attribution-lineage --stage test_plan --role gate_coverage --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
