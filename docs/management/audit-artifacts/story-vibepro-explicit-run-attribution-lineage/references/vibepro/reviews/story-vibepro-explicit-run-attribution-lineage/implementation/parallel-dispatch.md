...
- Current head: 3d97e5605b1738804713d598d29f3f73ce235d4e
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_12a833f98253b4d863bf69e40befe19e
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:ef223423d84c0c1167182e5d35fd651f66e13aa9ad03e103aecb7e8711923eb6
- current_verification_summary_fingerprint: sha256:ef223423d84c0c1167182e5d35fd651f66e13aa9ad03e103aecb7e8711923eb6
- verification_evidence_updated_at: 2026-07-21T10:56:47.800Z
- current_verification_evidence_updated_at: 2026-07-21T10:56:47.800Z
- preferred_order: -

Reuse key内のverification command timestamps:
- typecheck: executed_at=2026-07-21T10:56:47.800Z git_recorded_at=2026-07-21T10:56:47.762Z
- e2e: executed_at=2026-07-21T10:56:44.180Z git_recorded_at=2026-07-21T10:56:44.154Z
- unit: executed_at=2026-07-21T10:56:40.590Z git_recorded_at=2026-07-21T10:56:40.506Z
- integration: executed_at=2026-07-21T10:51:24.040Z git_recorded_at=2026-07-21T10:51:23.997Z
...
Stale reasons:
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:d75102ac2cc6bb2fb71d16fe893ee0a43abca0bde7f7b93e9f1b1647976ce0fe current=sha256:40bfff9224ad7858b1352ba6a1469d856178ee5a6717718c35925270391db7bb
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-explicit-run-attribution-lineage --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-explicit-run-attribution-lineage --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-explicit-run-attribution-lineage/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-explicit-run-attribution-lineage/implementation/review-request-code_spec_alignment.md`
...
`vibepro review record . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role code_spec_alignment --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role code_spec_alignment --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role code_spec_alignment --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-explicit-run-attribution-lineage/implementation/review-request-runtime_contract.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role runtime_contract --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role runtime_contract --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role runtime_contract --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-explicit-run-attribution-lineage/implementation/review-request-ux_completion.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role ux_completion --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role ux_completion --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-explicit-run-attribution-lineage --stage implementation --role ux_completion --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
