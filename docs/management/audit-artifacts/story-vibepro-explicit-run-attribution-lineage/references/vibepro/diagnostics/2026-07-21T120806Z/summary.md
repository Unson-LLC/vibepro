...
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=3dd925c83a3c dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4862 |
| graphify edges | 10956 |
| 共通スキャン対象 | 5964件 |
...
- before: 2026-07-21T091445Z / after: 2026-07-21T120806Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0235 (257 edges) | 14(file: 1, node: 103, edge: 255), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
