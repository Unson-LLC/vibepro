...
- Story: story-vibepro-post-merge-docs-clean-worktree
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: 971be8775b4cf2012a661612e508723a0dc7ab1a
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_73a3dd2c295c69c8441b1be9bd2a233d
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:ec2818f73b5b9e47334eab2fdb76a44b6ecf141e178fa79cd7140f79d3115f15
- current_verification_summary_fingerprint: sha256:95782ef8826d0baef0f47fa40efec9678498ecd9d27aa6f368eb26e2e07e9bfe
- verification_evidence_updated_at: 2026-07-19T01:05:13.653Z
- current_verification_evidence_updated_at: 2026-07-19T01:08:28.924Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-19T01:05:13.653Z git_recorded_at=2026-07-19T01:05:13.615Z
- build: executed_at=2026-07-19T01:05:12.640Z git_recorded_at=2026-07-19T01:05:12.638Z
- typecheck: executed_at=2026-07-19T01:05:11.736Z git_recorded_at=2026-07-19T01:05:11.734Z
- unit: executed_at=2026-07-19T01:05:10.891Z git_recorded_at=2026-07-19T01:05:10.889Z

現在のverification command timestamps:
- integration: executed_at=2026-07-19T01:08:28.924Z git_recorded_at=2026-07-19T01:08:28.916Z
- build: executed_at=2026-07-19T01:08:27.857Z git_recorded_at=2026-07-19T01:08:27.852Z
- unit: executed_at=2026-07-19T01:08:25.948Z git_recorded_at=2026-07-19T01:08:25.939Z
- typecheck: executed_at=2026-07-19T01:05:11.736Z git_recorded_at=2026-07-19T01:05:11.734Z

Stale reasons:
- head_sha: head_sha changed previous=8d9acc3e20225238b5ef674c98e6e6055383e301 current=971be8775b4cf2012a661612e508723a0dc7ab1a
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:c273601d3775be4b94b2298e6eb924b849a344a425b2df1477447700ac83b517 current=sha256:1df8bb4bde05df6bbf69f4b53d53b061182a3cc6515d701104792551c6e9c38c
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:ec2818f73b5b9e47334eab2fdb76a44b6ecf141e178fa79cd7140f79d3115f15 current=sha256:95782ef8826d0baef0f47fa40efec9678498ecd9d27aa6f368eb26e2e07e9bfe
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-07-19T01:05:13.653Z current=2026-07-19T01:08:28.924Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"integration","executed_at":"2026-07-19T01:05:13.653Z","git_recorded_at":"2026-07-19T01:05:13.615Z"},{"kind":"build","executed_at":"2026-07-19T01:05:12.640Z","git_recorded_at":"2026-07-19T01:05:12.638Z"},{"kind":"typecheck","executed_at":"2026-07-19T01:05:11.736Z","git_recorded_at":"2026-07-19T01:05:11.734Z"},{"kind":"unit","executed_at":"2026-07-19T01:05:10.891Z","git_recorded_at":"2026-07-19T01:05:10.889Z"}] current=[{"kind":"integration","executed_at":"2026-07-19T01:08:28.924Z","git_recorded_at":"2026-07-19T01:08:28.916Z"},{"kind":"build","executed_at":"2026-07-19T01:08:27.857Z","git_recorded_at":"2026-07-19T01:08:27.852Z"},{"kind":"unit","executed_at":"2026-07-19T01:08:25.948Z","git_recorded_at":"2026-07-19T01:08:25.939Z"},{"kind":"typecheck","executed_at":"2026-07-19T01:05:11.736Z","git_recorded_at":"2026-07-19T01:05:11.734Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-post-merge-docs-clean-worktree --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-post-merge-docs-clean-worktree --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-post-merge-docs-clean-worktree/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-post-merge-docs-clean-worktree/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-post-merge-docs-clean-worktree/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-post-merge-docs-clean-worktree/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-post-merge-docs-clean-worktree/gate/review-request-release_risk.md`
...
`vibepro review record . --id story-vibepro-post-merge-docs-clean-worktree --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-post-merge-docs-clean-worktree --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-post-merge-docs-clean-worktree --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
