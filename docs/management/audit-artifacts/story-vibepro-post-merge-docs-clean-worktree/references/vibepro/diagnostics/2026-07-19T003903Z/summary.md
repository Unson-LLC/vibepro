...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-19T003903Z |
| Story | Keep the post-merge docs deployment worktree clean |
| Story ID | story-vibepro-post-merge-docs-clean-worktree |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=a301343c4475 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
