...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-30T020928Z |
| Story | Session Cost入力障害を局所化して監査を継続する |
| Story ID | story-vibepro-session-cost-source-health-fail-soft |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.2 commit=dbcbaf818e89 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality, api-boundary |
| graphify nodes | 5751 |
| graphify edges | 12883 |
| 共通スキャン対象 | 8334件 |
...
- before: 2026-07-30T020536Z / after: 2026-07-30T020928Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0217 (279 edges) | 18(file: 1, node: 111, edge: 277), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
