...
| Story | 複数Storyを混載しないStory Run Portfolio Controller |
| Story ID | story-vibepro-story-run-portfolio-controller |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=b2a70d42cdf6 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
