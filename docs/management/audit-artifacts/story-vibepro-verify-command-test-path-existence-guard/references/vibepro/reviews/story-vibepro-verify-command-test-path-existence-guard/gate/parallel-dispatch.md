...
- Story: story-vibepro-verify-command-test-path-existence-guard
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: e416d297ad8942ba82f990795f4d4278b5325602
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_d1c16f71328feccb73ecbe820948b242
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:e81f3c49981f265162ce6b2c735886e9f231c2d050b1fc97c9b9a0f794783dd5
- current_verification_summary_fingerprint: sha256:3ea373d484afd982179b035d0ad55e8c73ebd268ffa54b18b333daa6524c6eaf
- verification_evidence_updated_at: 2026-07-30T10:06:10.923Z
- current_verification_evidence_updated_at: 2026-07-30T10:23:42.242Z
- preferred_order: -

Reuse key内のverification command timestamps:
- typecheck: executed_at=2026-07-30T10:06:10.008Z git_recorded_at=2026-07-30T10:06:10.900Z
- e2e: executed_at=2026-07-30T10:05:55.549Z git_recorded_at=2026-07-30T10:05:56.282Z
- unit: executed_at=2026-07-30T10:05:23.535Z git_recorded_at=2026-07-30T10:05:24.452Z

現在のverification command timestamps:
- typecheck: executed_at=2026-07-30T10:23:41.156Z git_recorded_at=2026-07-30T10:23:42.214Z
- e2e: executed_at=2026-07-30T10:23:22.606Z git_recorded_at=2026-07-30T10:23:23.394Z
- unit: executed_at=2026-07-30T10:23:13.640Z git_recorded_at=2026-07-30T10:23:14.742Z

Stale reasons:
- head_sha: head_sha changed previous=0ad4a2bc0313b738f2c0cd1d2a4ae311bbc154a5 current=aa57f5dac2519ca3e136d1c0fe1e22494b8c94ab
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:07908759d794e5f11a80379609dc89ae7bbb241744670753e7a7b70abf7e9905 current=sha256:e81f3c49981f265162ce6b2c735886e9f231c2d050b1fc97c9b9a0f794783dd5
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-30T10:02:02.475Z current=2026-07-30T10:06:10.923Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"e2e","executed_at":"2026-07-30T10:02:01.832Z","git_recorded_at":"2026-07-30T10:02:02.465Z"},{"kind":"unit","executed_at":"2026-07-30T10:00:41.770Z","git_recorded_at":"2026-07-30T10:00:42.457Z"},{"kind":"typecheck","executed_at":"2026-07-30T10:00:01.744Z","git_recorded_at":"2026-07-30T10:00:02.449Z"}] current=[{"kind":"typecheck","executed_at":"2026-07-30T10:06:10.008Z","git_recorded_at":"2026-07-30T10:06:10.900Z"},{"kind":"e2e","executed_at":"2026-07-30T10:05:55.549Z","git_recorded_at":"2026-07-30T10:05:56.282Z"},{"kind":"unit","executed_at":"2026-07-30T10:05:23.535Z","git_recorded_at":"2026-07-30T10:05:24.452Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:ca830ab407bdf490ac6fd55865d03d33f5266ec86a3a9486c4e8dc5f7382655a current=sha256:3a74359ceeaacf92d37dcba541ee8123de9ce0437092024e3da3f27d25c71132
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-verify-command-test-path-existence-guard --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-verify-command-test-path-existence-guard --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-verify-command-test-path-existence-guard/evidence-reuse.summary.json`（bounded summary。まずこれを読む）。full artifact `evidence-reuse.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-verify-command-test-path-existence-guard/evidence-plan.summary.json`（bounded summary。まずこれを読む）。full artifact `evidence-plan.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-verify-command-test-path-existence-guard/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-verify-command-test-path-existence-guard/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-verify-command-test-path-existence-guard/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-verify-command-test-path-existence-guard/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-verify-command-test-path-existence-guard/split-plan.summary.json`（bounded summary。まずこれを読む）。full artifact `split-plan.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-verify-command-test-path-existence-guard/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-verify-command-test-path-existence-guard/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-verify-command-test-path-existence-guard --stage gate --role gate_evidence --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-verify-command-test-path-existence-guard --stage gate --role gate_evidence --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-verify-command-test-path-existence-guard --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-verify-command-test-path-existence-guard --stage gate --role gate_evidence --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
