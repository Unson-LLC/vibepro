...
- Story: story-vibepro-visual-evidence-gate-ux
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: b432266582cc07a99a286d7047571a874881159b
- User dirty: false
- Raw dirty: false
...
- status: fresh
- evidence_key: evk_8abe6fd4947c5271f6d18501d9957891
- first_input: true
- reason: Fresh evidence summary/index can be used as first review input.
- verification_summary_fingerprint: sha256:f518bbec2a5d11637a329cae48807c1ac1f23e251df2b22af57eee918ca35ae5
- current_verification_summary_fingerprint: sha256:f518bbec2a5d11637a329cae48807c1ac1f23e251df2b22af57eee918ca35ae5
- verification_evidence_updated_at: 2026-07-04T19:48:04.690Z
- current_verification_evidence_updated_at: 2026-07-04T19:48:04.690Z
- preferred_order: .vibepro/pr/story-vibepro-visual-evidence-gate-ux/evidence-reuse.json, .vibepro/pr/story-vibepro-visual-evidence-gate-ux/decision-index.json, .vibepro/pr/story-vibepro-visual-evidence-gate-ux/evidence-plan.json, .vibepro/pr/story-vibepro-visual-evidence-gate-ux/pr-prepare.json, .vibepro/pr/story-vibepro-visual-evidence-gate-ux/gate-dag.json

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-04T19:48:04.690Z git_recorded_at=2026-07-04T19:48:04.689Z
- integration: executed_at=2026-07-04T19:48:04.676Z git_recorded_at=2026-07-04T19:48:04.623Z
- typecheck: executed_at=2026-07-04T19:48:04.624Z git_recorded_at=2026-07-04T19:48:04.622Z
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-visual-evidence-gate-ux --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-visual-evidence-gate-ux --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-visual-evidence-gate-ux/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-visual-evidence-gate-ux --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-visual-evidence-gate-ux --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-visual-evidence-gate-ux --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
