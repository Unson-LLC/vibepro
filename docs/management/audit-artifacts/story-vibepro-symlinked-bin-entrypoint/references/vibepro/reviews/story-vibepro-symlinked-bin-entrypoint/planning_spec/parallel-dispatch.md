...
- Current head: f7402303ea02efb02f6e70b3216bfe8c91279867
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_ece84180956517a0c574b4c5c36f627e
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:3673fad938cd9f8efc802a4d85848f0291316597e625a36c836ff71a6b230701
- current_verification_summary_fingerprint: sha256:3673fad938cd9f8efc802a4d85848f0291316597e625a36c836ff71a6b230701
- verification_evidence_updated_at: 2026-07-19T23:51:40.889Z
- current_verification_evidence_updated_at: 2026-07-19T23:51:40.889Z
- preferred_order: -

Reuse key内のverification command timestamps:
- typecheck: executed_at=2026-07-19T23:51:40.889Z git_recorded_at=2026-07-19T23:51:40.888Z
- integration: executed_at=2026-07-19T23:51:40.116Z git_recorded_at=2026-07-19T23:51:40.114Z
- unit: executed_at=2026-07-19T23:51:39.198Z git_recorded_at=2026-07-19T23:51:39.196Z
...
Stale reasons:
- head_sha: head_sha changed previous=ec4889ed8d9f27d6743b1ef12f73dcd358b42a3f current=f7402303ea02efb02f6e70b3216bfe8c91279867
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:64b2671e32d376c2dca0a4ac72cfa0b4cdda738a1f3d4ffb261ed73a83a07279 current=sha256:3673fad938cd9f8efc802a4d85848f0291316597e625a36c836ff71a6b230701
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-19T23:48:32.178Z current=2026-07-19T23:51:40.889Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"unit","executed_at":"2026-07-19T23:48:32.178Z","git_recorded_at":"2026-07-19T23:48:32.177Z"},{"kind":"typecheck","executed_at":"2026-07-19T23:40:43.136Z","git_recorded_at":"2026-07-19T23:40:43.133Z"},{"kind":"integration","executed_at":"2026-07-19T23:40:41.666Z","git_recorded_at":"2026-07-19T23:40:41.664Z"}] current=[{"kind":"typecheck","executed_at":"2026-07-19T23:51:40.889Z","git_recorded_at":"2026-07-19T23:51:40.888Z"},{"kind":"integration","executed_at":"2026-07-19T23:51:40.116Z","git_recorded_at":"2026-07-19T23:51:40.114Z"},{"kind":"unit","executed_at":"2026-07-19T23:51:39.198Z","git_recorded_at":"2026-07-19T23:51:39.196Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:a057770e292ed8d3c1c240eed589ad448e386faa4a62493f98afe50ab24427a7 current=sha256:0ffeb640c875c29aa00ad933f6f1c10ba85a93bffc581c9ddcc276ff00f43752
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-symlinked-bin-entrypoint --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-symlinked-bin-entrypoint/planning_spec/review-request-product_requirement.md`
...
`vibepro review record . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role product_requirement --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role product_requirement --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role product_requirement --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-symlinked-bin-entrypoint/planning_spec/review-request-architecture_boundary.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role architecture_boundary --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role architecture_boundary --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role architecture_boundary --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-symlinked-bin-entrypoint/planning_spec/review-request-spec_consistency.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role spec_consistency --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role spec_consistency --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-symlinked-bin-entrypoint --stage planning_spec --role spec_consistency --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
