...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-symlinked-bin-entrypoint --stage test_plan` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-symlinked-bin-entrypoint --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-symlinked-bin-entrypoint/test_plan/review-request-unit_integration.md`
...
`vibepro review record . --id story-vibepro-symlinked-bin-entrypoint --stage test_plan --role unit_integration --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-symlinked-bin-entrypoint --stage test_plan --role unit_integration --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-symlinked-bin-entrypoint --stage test_plan --role unit_integration --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-symlinked-bin-entrypoint/test_plan/review-request-e2e_ux.md`
...
Lifecycle start command:
`vibepro review start . --id story-vibepro-symlinked-bin-entrypoint --stage test_plan --role e2e_ux --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-symlinked-bin-entrypoint --stage test_plan --role e2e_ux --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-symlinked-bin-entrypoint/test_plan/review-request-gate_coverage.md`
...
Lifecycle start command:
`vibepro review start . --id story-vibepro-symlinked-bin-entrypoint --stage test_plan --role gate_coverage --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-symlinked-bin-entrypoint --stage test_plan --role gate_coverage --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
