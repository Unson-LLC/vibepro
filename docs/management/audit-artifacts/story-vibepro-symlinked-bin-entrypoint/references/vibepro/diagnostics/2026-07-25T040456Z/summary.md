...
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=dac459d7192b dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality, api-boundary |
| graphify nodes | 5603 |
| graphify edges | 12586 |
| 共通スキャン対象 | 7984件 |
...
- before: 2026-07-19T232620Z / after: 2026-07-25T040456Z
- 改善: 0件 / 解消: 0件 / 悪化: 0件 / 新規: 1件
- 主な改善: なし
- 次の候補:
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0218 (275 edges) | 17(file: 1, node: 110, edge: 273), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
