...
| VibePro Runtime | vibepro@0.2.0-beta.2 commit=86101569031d dirty=false |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality, api-boundary |
| graphify nodes | 5779 |
| graphify edges | 12929 |
| 共通スキャン対象 | 8394件 |
...
- before: 2026-07-30T112444Z / after: 2026-07-30T125918Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0216 (279 edges) | 17(file: 1, node: 112, edge: 279) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
