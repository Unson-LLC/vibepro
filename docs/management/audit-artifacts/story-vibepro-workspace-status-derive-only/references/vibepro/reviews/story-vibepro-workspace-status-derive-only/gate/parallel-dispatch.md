...
- Current head: f1547d8a5efdccbeea9caae7f118195f29f3d5d2
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_9e239c2ccb181104660d1c51bf77d765
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:4de56dbbd5cae3b0bba58313e87c719a7bdf4da705d7615ea5ccd8999dc29a48
- current_verification_summary_fingerprint: sha256:4de56dbbd5cae3b0bba58313e87c719a7bdf4da705d7615ea5ccd8999dc29a48
- verification_evidence_updated_at: 2026-07-11T16:36:27.481Z
- current_verification_evidence_updated_at: 2026-07-11T16:36:27.481Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-11T16:36:27.481Z git_recorded_at=2026-07-11T16:36:27.465Z
- typecheck: executed_at=2026-07-11T16:35:22.533Z git_recorded_at=2026-07-11T16:35:22.501Z
- e2e: executed_at=2026-07-11T16:35:18.821Z git_recorded_at=2026-07-11T16:35:18.806Z
- integration: executed_at=2026-07-11T16:35:15.236Z git_recorded_at=2026-07-11T16:35:15.227Z
...
Stale reasons:
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:9acf817aec465f5b3fcd736e97a87b4298dc17747d2cf7a7d76a38689870868e current=sha256:4de56dbbd5cae3b0bba58313e87c719a7bdf4da705d7615ea5ccd8999dc29a48
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-11T16:35:58.931Z current=2026-07-11T16:36:27.481Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"unit","executed_at":"2026-07-11T16:35:58.931Z","git_recorded_at":"2026-07-11T16:35:58.898Z"},{"kind":"typecheck","executed_at":"2026-07-11T16:35:22.533Z","git_recorded_at":"2026-07-11T16:35:22.501Z"},{"kind":"e2e","executed_at":"2026-07-11T16:35:18.821Z","git_recorded_at":"2026-07-11T16:35:18.806Z"},{"kind":"integration","executed_at":"2026-07-11T16:35:15.236Z","git_recorded_at":"2026-07-11T16:35:15.227Z"}] current=[{"kind":"unit","executed_at":"2026-07-11T16:36:27.481Z","git_recorded_at":"2026-07-11T16:36:27.465Z"},{"kind":"typecheck","executed_at":"2026-07-11T16:35:22.533Z","git_recorded_at":"2026-07-11T16:35:22.501Z"},{"kind":"e2e","executed_at":"2026-07-11T16:35:18.821Z","git_recorded_at":"2026-07-11T16:35:18.806Z"},{"kind":"integration","executed_at":"2026-07-11T16:35:15.236Z","git_recorded_at":"2026-07-11T16:35:15.227Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-workspace-status-derive-only --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-workspace-status-derive-only --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-workspace-status-derive-only/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-workspace-status-derive-only/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-workspace-status-derive-only/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-workspace-status-derive-only/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
## Subagent 1: gate:pr_split_scope

Review request:
`.vibepro/reviews/story-vibepro-workspace-status-derive-only/gate/review-request-pr_split_scope.md`
...
Review request:
`.vibepro/reviews/story-vibepro-workspace-status-derive-only/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-workspace-status-derive-only --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-workspace-status-derive-only --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-workspace-status-derive-only --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
