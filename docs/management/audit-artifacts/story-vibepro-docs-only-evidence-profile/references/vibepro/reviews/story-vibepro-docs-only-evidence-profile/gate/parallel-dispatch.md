...
- Current head: 9443767173f2a1faf9d318931f5a1109009f3723
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_5defc1076c425bd48c214229e0fd471b
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:fd25edcf1d379a8e744d977b8a65376739291cae0e4de5be2cff702a4dc4f58d
- current_verification_summary_fingerprint: sha256:fd25edcf1d379a8e744d977b8a65376739291cae0e4de5be2cff702a4dc4f58d
- verification_evidence_updated_at: 2026-07-25T13:46:11.570Z
- current_verification_evidence_updated_at: 2026-07-25T13:46:11.570Z
- preferred_order: -

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-25T13:46:11.569Z git_recorded_at=2026-07-25T13:46:11.551Z
- integration: executed_at=2026-07-25T13:46:10.171Z git_recorded_at=2026-07-25T13:46:10.149Z
- unit: executed_at=2026-07-25T13:46:08.902Z git_recorded_at=2026-07-25T13:46:08.881Z
...
Stale reasons:
- head_sha: head_sha changed previous=490d44663253460d0d65e91e8838acbcd6f16ff4 current=9443767173f2a1faf9d318931f5a1109009f3723
- spec_fingerprint: spec_fingerprint changed previous=sha256:0c53b947a8f1d20280e7bd56c594204fa71131b7c0526511f56ac952b741966f current=sha256:996e065381f69cbace4130dedfa49033f5e48815179fa2b4cf9e87ade81bfc30
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:7728dfeb36b53705a48facd66e77dcf0e776855fd7df2f520d894fe961ce43fd current=sha256:fd25edcf1d379a8e744d977b8a65376739291cae0e4de5be2cff702a4dc4f58d
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-25T13:26:05.275Z current=2026-07-25T13:46:11.570Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"e2e","executed_at":"2026-07-25T13:26:05.275Z","git_recorded_at":"2026-07-25T13:26:05.214Z"},{"kind":"integration","executed_at":"2026-07-25T13:26:02.488Z","git_recorded_at":"2026-07-25T13:26:02.444Z"},{"kind":"unit","executed_at":"2026-07-25T13:25:59.735Z","git_recorded_at":"2026-07-25T13:25:59.640Z"}] current=[{"kind":"e2e","executed_at":"2026-07-25T13:46:11.569Z","git_recorded_at":"2026-07-25T13:46:11.551Z"},{"kind":"integration","executed_at":"2026-07-25T13:46:10.171Z","git_recorded_at":"2026-07-25T13:46:10.149Z"},{"kind":"unit","executed_at":"2026-07-25T13:46:08.902Z","git_recorded_at":"2026-07-25T13:46:08.881Z"}]

## Decision Outcome Ledger Summary

- ledger: .vibepro/pr/story-vibepro-docs-only-evidence-profile/decision-outcome-ledger.json
- digest: 163a4f56f9389901b6245796f066cffa33206c70eb73b1493bbb1eadbf8b0f1d
- total: 5
- returned: 5
- omitted: 0
- truncated: false
- partial decision_trace_id=dt_0e757e2b0d5c196a3c94b9222d80f57bc03eab28bf3b62dcbc97c695d927b4c5 parent_revision=964574e33753fa9dcb67d8268c5cae0d84223c6e2ad60436f449d661efaddfac chain={"finding":null,"disposition":null,"decision":null,"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
- partial decision_trace_id=dt_8d95917a2ec957132a8a1aa26bc42355a6c5e03ac7ee0df8592fdf0f8a804e6d parent_revision=4d527e39925b2326c14a559d11be0fad267d905dfcbac8327ecf0b2279660a0f chain={"finding":null,"disposition":null,"decision":null,"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
- partial decision_trace_id=dt_ad22999150c262154b97c1c30c7240088cdf01a07ab1d673a388e9b9ba27b000 parent_revision=1a2b59c0c7e43d98b5c7ba9aa5c7874a2c01390deecc26ac33e0de8e42850c3a chain={"finding":null,"disposition":null,"decision":{},"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
- partial decision_trace_id=dt_c525697b306a3c858482dadf51291110c01a1bc5d7168e6cceb0e81ff8f27cfa parent_revision=7d386242fd1bbd53af6714df7a4b7184a8e964cc82360c077bb135324ef39452 chain={"finding":null,"disposition":null,"decision":null,"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
- partial decision_trace_id=dt_e45ab45ea0d3e42ba9d3d836a8bf9e5eb8b0f6c5f1f8615a40cc861f383f3a8a parent_revision=d3be8bd04ef7c17153d57108ea5afe085a546a0c66c9d171be1128615d8b0003 chain={"finding":null,"disposition":null,"decision":null,"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-docs-only-evidence-profile --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-docs-only-evidence-profile --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-docs-only-evidence-profile/evidence-reuse.summary.json`（bounded summary。まずこれを読む）。full artifact `evidence-reuse.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-docs-only-evidence-profile/evidence-plan.summary.json`（bounded summary。まずこれを読む）。full artifact `evidence-plan.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-docs-only-evidence-profile/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-docs-only-evidence-profile/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-docs-only-evidence-profile/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-docs-only-evidence-profile/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-docs-only-evidence-profile/split-plan.summary.json`（bounded summary。まずこれを読む）。full artifact `split-plan.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-docs-only-evidence-profile/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-docs-only-evidence-profile/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-docs-only-evidence-profile --stage gate --role gate_evidence --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-docs-only-evidence-profile --stage gate --role gate_evidence --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-docs-only-evidence-profile --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-docs-only-evidence-profile --stage gate --role gate_evidence --agent-id "<replacement-agent-id>" --close-reason "<completed|timeout|replaced|manual_shutdown>" --close-evidence "<replacement-agent-close-evidence>"`
