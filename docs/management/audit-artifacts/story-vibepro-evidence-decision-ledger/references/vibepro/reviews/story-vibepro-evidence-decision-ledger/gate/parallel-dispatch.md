...
- Story: story-vibepro-evidence-decision-ledger
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: 9828d893292d2e5de1308211b2884ef510afe88d
- User dirty: false
- Raw dirty: false
...
- status: fresh
- evidence_key: evk_6a16afd1b8ec90b11ae5f624447ee119
- first_input: true
- reason: Fresh evidence summary/index can be used as first review input.
- verification_summary_fingerprint: sha256:3bf9dba1a3201fe56d4c79e3f8d65aae2b0a9091c50395926a65a220c74847e3
- current_verification_summary_fingerprint: sha256:3bf9dba1a3201fe56d4c79e3f8d65aae2b0a9091c50395926a65a220c74847e3
- verification_evidence_updated_at: 2026-07-12T15:32:54.620Z
- current_verification_evidence_updated_at: 2026-07-12T15:32:54.620Z
- preferred_order: .vibepro/pr/story-vibepro-evidence-decision-ledger/evidence-reuse.json, .vibepro/pr/story-vibepro-evidence-decision-ledger/decision-index.json, .vibepro/pr/story-vibepro-evidence-decision-ledger/evidence-plan.json, .vibepro/pr/story-vibepro-evidence-decision-ledger/pr-prepare.json

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-12T15:32:54.620Z git_recorded_at=2026-07-12T15:32:54.614Z
- typecheck: executed_at=2026-07-12T15:23:08.076Z git_recorded_at=2026-07-12T15:23:08.075Z
- unit: executed_at=2026-07-12T15:23:06.847Z git_recorded_at=2026-07-12T15:23:06.846Z
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-evidence-decision-ledger --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-evidence-decision-ledger --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-evidence-decision-ledger/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-evidence-decision-ledger/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-evidence-decision-ledger/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-evidence-decision-ledger/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-evidence-decision-ledger --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-evidence-decision-ledger --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-evidence-decision-ledger --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
