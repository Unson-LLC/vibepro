...
- Story: story-vibepro-artifact-value-ledger
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: 8abfdc9ff29259fde67cd3730b357503dbf1134c
- User dirty: false
- Raw dirty: false
...
- status: fresh
- evidence_key: evk_61ea76acfa998504b89218718354937d
- first_input: true
- reason: Fresh evidence summary/index can be used as first review input.
- verification_summary_fingerprint: sha256:51aca8f007570fd6827b718c52638d4e0673d7843a48aae3007b762440976833
- current_verification_summary_fingerprint: sha256:51aca8f007570fd6827b718c52638d4e0673d7843a48aae3007b762440976833
- verification_evidence_updated_at: 2026-07-01T03:28:20.711Z
- current_verification_evidence_updated_at: 2026-07-01T03:28:20.711Z
- preferred_order: .vibepro/pr/story-vibepro-artifact-value-ledger/evidence-reuse.json, .vibepro/pr/story-vibepro-artifact-value-ledger/decision-index.json, .vibepro/pr/story-vibepro-artifact-value-ledger/evidence-plan.json, .vibepro/pr/story-vibepro-artifact-value-ledger/pr-prepare.json, .vibepro/pr/story-vibepro-artifact-value-ledger/gate-dag.json

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-01T03:28:20.711Z git_recorded_at=2026-07-01T03:28:20.709Z
- typecheck: executed_at=2026-07-01T03:28:02.275Z git_recorded_at=2026-07-01T03:28:02.274Z
- unit: executed_at=2026-07-01T03:27:55.882Z git_recorded_at=2026-07-01T03:27:55.880Z
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-artifact-value-ledger --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-artifact-value-ledger --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-artifact-value-ledger/gate/review-request-gate_evidence.md`
...
`vibepro review start . --id story-vibepro-artifact-value-ledger --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-artifact-value-ledger --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
