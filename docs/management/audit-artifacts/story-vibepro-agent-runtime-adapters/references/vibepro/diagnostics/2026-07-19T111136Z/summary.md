...
| Story | 実装・Reviewを委譲するProvider-neutral Agent Runtime Adapter |
| Story ID | story-vibepro-agent-runtime-adapters |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=ec4889ed8d9f dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4592 |
| graphify edges | 10243 |
| 共通スキャン対象 | 5196件 |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0216 (221 edges) | 17(file: 1, node: 91, edge: 219), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
