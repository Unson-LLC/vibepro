...
- REQ-INV-001: required Reviewは実装sessionと分離したidentityで並列起動し、既存review lifecycleへ記録する。 (story:docs/management/stories/active/story-vibepro-agent-runtime-adapters.md)
