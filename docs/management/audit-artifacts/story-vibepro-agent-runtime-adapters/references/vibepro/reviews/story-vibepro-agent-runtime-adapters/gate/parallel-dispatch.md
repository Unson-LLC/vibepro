...
- Story: story-vibepro-agent-runtime-adapters
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 3
- Current head: 2800e8be37dca4e26c52873898b152f865433524
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_37386f6efca601efec824266d6e8ed43
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:1b4dc35b3a769656b07b9eff5981fb10285ee46f0b6e0db06d0767b0bf573306
- current_verification_summary_fingerprint: sha256:8b5f9f2d7d591cd9566a8a2f2c80365975582e4c24caedc5281d1636ca320ebc
- verification_evidence_updated_at: 2026-07-19T23:33:01.246Z
- current_verification_evidence_updated_at: 2026-07-19T23:41:23.104Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-19T23:33:01.246Z git_recorded_at=2026-07-19T23:33:01.198Z
- e2e: executed_at=2026-07-19T23:33:01.217Z git_recorded_at=2026-07-19T23:33:01.210Z
- integration: executed_at=2026-07-19T23:33:01.207Z git_recorded_at=2026-07-19T23:33:01.197Z

現在のverification command timestamps:
- e2e: executed_at=2026-07-19T23:41:23.104Z git_recorded_at=2026-07-19T23:41:23.097Z
- integration: executed_at=2026-07-19T23:41:22.341Z git_recorded_at=2026-07-19T23:41:22.334Z
- unit: executed_at=2026-07-19T23:41:21.596Z git_recorded_at=2026-07-19T23:41:21.589Z

Stale reasons:
- head_sha: review prepare current HEAD does not match evidence key HEAD previous=a8735db160e9425f7b6762f7c6720b19d5fe221f current=2800e8be37dca4e26c52873898b152f865433524
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:1b4dc35b3a769656b07b9eff5981fb10285ee46f0b6e0db06d0767b0bf573306 current=sha256:8b5f9f2d7d591cd9566a8a2f2c80365975582e4c24caedc5281d1636ca320ebc
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-07-19T23:33:01.246Z current=2026-07-19T23:41:23.104Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"unit","executed_at":"2026-07-19T23:33:01.246Z","git_recorded_at":"2026-07-19T23:33:01.198Z"},{"kind":"e2e","executed_at":"2026-07-19T23:33:01.217Z","git_recorded_at":"2026-07-19T23:33:01.210Z"},{"kind":"integration","executed_at":"2026-07-19T23:33:01.207Z","git_recorded_at":"2026-07-19T23:33:01.197Z"}] current=[{"kind":"e2e","executed_at":"2026-07-19T23:41:23.104Z","git_recorded_at":"2026-07-19T23:41:23.097Z"},{"kind":"integration","executed_at":"2026-07-19T23:41:22.341Z","git_recorded_at":"2026-07-19T23:41:22.334Z"},{"kind":"unit","executed_at":"2026-07-19T23:41:21.596Z","git_recorded_at":"2026-07-19T23:41:21.589Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-agent-runtime-adapters --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-agent-runtime-adapters --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-agent-runtime-adapters/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-agent-runtime-adapters/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-agent-runtime-adapters/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-agent-runtime-adapters/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-agent-runtime-adapters --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-agent-runtime-adapters --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-agent-runtime-adapters --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-agent-runtime-adapters/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-agent-runtime-adapters --stage gate --role pr_split_scope --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-agent-runtime-adapters --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-agent-runtime-adapters --stage gate --role pr_split_scope --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-agent-runtime-adapters/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-agent-runtime-adapters --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-agent-runtime-adapters --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-agent-runtime-adapters --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
