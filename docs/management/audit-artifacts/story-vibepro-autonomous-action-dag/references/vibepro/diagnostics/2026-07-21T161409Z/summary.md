...
| Story | Guarded Runを完全な型付き自律Action DAGへ拡張する |
| Story ID | story-vibepro-autonomous-action-dag |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=8e03c8e8ed7a dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4871 |
| graphify edges | 10977 |
| 共通スキャン対象 | 6143件 |
...
- before: 2026-07-21T110415Z / after: 2026-07-21T161409Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0234 (257 edges) | 15(file: 1, node: 104, edge: 257) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
