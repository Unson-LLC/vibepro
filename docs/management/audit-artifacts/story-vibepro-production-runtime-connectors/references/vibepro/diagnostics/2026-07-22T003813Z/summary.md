...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-22T003813Z |
| Story | Agent Runtime Adapterへproduction connectorを接続する |
| Story ID | story-vibepro-production-runtime-connectors |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=c8b549aa6713 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4928 |
| graphify edges | 11082 |
| 共通スキャン対象 | 6683件 |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0248 (275 edges) | 11(file: 1, node: 111, edge: 275) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
