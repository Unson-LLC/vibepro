...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-07T032224Z |
| Story | GitHub PR本文の65,536文字制限をVibeProのPR作成前に吸収する |
| Story ID | story-vibepro-pr-body-limit-guard |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=74c0ad6b7579 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0211 (179 edges) | 16(file: 1, node: 79, edge: 179) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
