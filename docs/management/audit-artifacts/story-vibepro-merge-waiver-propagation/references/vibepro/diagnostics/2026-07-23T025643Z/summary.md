...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-23T025643Z |
| Story | PR作成時の監査可能なGate waiverをexecute mergeへ安全に伝播する |
| Story ID | story-vibepro-merge-waiver-propagation |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=75d5d0158d9a dirty=false |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 5044 |
| graphify edges | 11332 |
| 共通スキャン対象 | 6908件 |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0243 (275 edges) | 14(file: 1, node: 111, edge: 275) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
