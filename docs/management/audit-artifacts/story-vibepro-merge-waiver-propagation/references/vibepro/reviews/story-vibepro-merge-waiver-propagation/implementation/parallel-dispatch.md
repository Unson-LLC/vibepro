...
- status: stale
- evidence_key: evk_f14a272d29661134d2c225e781ca2d66
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:b784e7109957f213cbd1cade57899a5fe1e8c65b8eb0c0afc944bf1faaa69007
- current_verification_summary_fingerprint: sha256:a80031aea0fc6f60fbfabe38bd8fe0323115d9c9f87b223b35b68151a0fbd331
- verification_evidence_updated_at: 2026-07-23T08:22:40.328Z
- current_verification_evidence_updated_at: 2026-07-23T08:26:03.032Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-23T08:22:40.328Z git_recorded_at=2026-07-23T08:22:40.327Z
- e2e: executed_at=2026-07-23T08:08:57.737Z git_recorded_at=2026-07-23T08:08:57.705Z
- unit: executed_at=2026-07-23T08:08:17.541Z git_recorded_at=2026-07-23T08:08:17.503Z
...
- e2e: executed_at=2026-07-23T08:26:03.032Z git_recorded_at=2026-07-23T08:26:02.999Z
- integration: executed_at=2026-07-23T08:22:40.328Z git_recorded_at=2026-07-23T08:22:40.327Z
- unit: executed_at=2026-07-23T08:08:17.541Z git_recorded_at=2026-07-23T08:08:17.503Z
- build: executed_at=2026-07-23T06:45:36.094Z git_recorded_at=2026-07-23T06:45:36.085Z
- typecheck: executed_at=2026-07-23T06:45:35.123Z git_recorded_at=2026-07-23T06:45:35.114Z
...
Stale reasons:
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:b784e7109957f213cbd1cade57899a5fe1e8c65b8eb0c0afc944bf1faaa69007 current=sha256:a80031aea0fc6f60fbfabe38bd8fe0323115d9c9f87b223b35b68151a0fbd331
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-07-23T08:22:40.328Z current=2026-07-23T08:26:03.032Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"integration","executed_at":"2026-07-23T08:22:40.328Z","git_recorded_at":"2026-07-23T08:22:40.327Z"},{"kind":"e2e","executed_at":"2026-07-23T08:08:57.737Z","git_recorded_at":"2026-07-23T08:08:57.705Z"},{"kind":"unit","executed_at":"2026-07-23T08:08:17.541Z","git_recorded_at":"2026-07-23T08:08:17.503Z"},{"kind":"build","executed_at":"2026-07-23T06:45:36.094Z","git_recorded_at":"2026-07-23T06:45:36.085Z"},{"kind":"typecheck","executed_at":"2026-07-23T06:45:35.123Z","git_recorded_at":"2026-07-23T06:45:35.114Z"}] current=[{"kind":"e2e","executed_at":"2026-07-23T08:26:03.032Z","git_recorded_at":"2026-07-23T08:26:02.999Z"},{"kind":"integration","executed_at":"2026-07-23T08:22:40.328Z","git_recorded_at":"2026-07-23T08:22:40.327Z"},{"kind":"unit","executed_at":"2026-07-23T08:08:17.541Z","git_recorded_at":"2026-07-23T08:08:17.503Z"},{"kind":"build","executed_at":"2026-07-23T06:45:36.094Z","git_recorded_at":"2026-07-23T06:45:36.085Z"},{"kind":"typecheck","executed_at":"2026-07-23T06:45:35.123Z","git_recorded_at":"2026-07-23T06:45:35.114Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-merge-waiver-propagation --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-merge-waiver-propagation --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-merge-waiver-propagation/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-merge-waiver-propagation/implementation/review-request-runtime_contract.md`
...
`vibepro review record . --id story-vibepro-merge-waiver-propagation --stage implementation --role runtime_contract --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-merge-waiver-propagation --stage implementation --role runtime_contract --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-merge-waiver-propagation --stage implementation --role runtime_contract --agent-system <codex|claude_code> --agent-id "<subagent-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-merge-waiver-propagation --stage implementation --role runtime_contract --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
