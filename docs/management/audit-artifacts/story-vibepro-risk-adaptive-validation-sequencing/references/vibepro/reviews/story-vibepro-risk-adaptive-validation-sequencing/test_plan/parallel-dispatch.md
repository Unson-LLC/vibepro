...
- status: stale
- evidence_key: evk_085050023a486978567ecea127ec7665
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:bd232cb756514315c89769c02e2925fdbe6c30b3850b804de18e4b1904911255
- current_verification_summary_fingerprint: sha256:0e7e09ae3028848501a35a47a20cfbb458b9a6e685b4065eafba42b3da0fd01c
- verification_evidence_updated_at: 2026-07-20T10:09:26.526Z
- current_verification_evidence_updated_at: 2026-07-20T10:09:57.522Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-20T10:09:26.526Z git_recorded_at=2026-07-20T10:09:26.519Z
...
Stale reasons:
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:bd232cb756514315c89769c02e2925fdbe6c30b3850b804de18e4b1904911255 current=sha256:0e7e09ae3028848501a35a47a20cfbb458b9a6e685b4065eafba42b3da0fd01c
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-07-20T10:09:26.526Z current=2026-07-20T10:09:57.522Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"unit","executed_at":"2026-07-20T10:09:26.526Z","git_recorded_at":"2026-07-20T10:09:26.519Z"},{"kind":"typecheck","executed_at":"2026-07-20T10:09:14.898Z","git_recorded_at":"2026-07-20T10:09:14.896Z"},{"kind":"e2e","executed_at":"2026-07-20T10:05:11.498Z","git_recorded_at":"2026-07-20T10:05:11.491Z"},{"kind":"integration","executed_at":"2026-07-20T10:05:10.688Z","git_recorded_at":"2026-07-20T10:05:10.679Z"}] current=[{"kind":"unit","executed_at":"2026-07-20T10:09:57.522Z","git_recorded_at":"2026-07-20T10:09:57.513Z"},{"kind":"typecheck","executed_at":"2026-07-20T10:09:14.898Z","git_recorded_at":"2026-07-20T10:09:14.896Z"},{"kind":"e2e","executed_at":"2026-07-20T10:05:11.498Z","git_recorded_at":"2026-07-20T10:05:11.491Z"},{"kind":"integration","executed_at":"2026-07-20T10:05:10.688Z","git_recorded_at":"2026-07-20T10:05:10.679Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-risk-adaptive-validation-sequencing --stage test_plan` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-risk-adaptive-validation-sequencing --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-risk-adaptive-validation-sequencing/test_plan/review-request-e2e_ux.md`
...
`vibepro review record . --id story-vibepro-risk-adaptive-validation-sequencing --stage test_plan --role e2e_ux --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-risk-adaptive-validation-sequencing --stage test_plan --role e2e_ux --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-risk-adaptive-validation-sequencing --stage test_plan --role e2e_ux --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-risk-adaptive-validation-sequencing/test_plan/review-request-gate_coverage.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-risk-adaptive-validation-sequencing --stage test_plan --role gate_coverage --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-risk-adaptive-validation-sequencing --stage test_plan --role gate_coverage --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-risk-adaptive-validation-sequencing --stage test_plan --role gate_coverage --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
