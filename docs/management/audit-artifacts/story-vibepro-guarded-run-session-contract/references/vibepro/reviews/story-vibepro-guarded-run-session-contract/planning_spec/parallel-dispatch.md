...
- status: fresh
- evidence_key: evk_a6f296471818e56c6bd9d31830e1a30b
- first_input: true
- reason: Fresh evidence summary/index can be used as first review input.
- verification_summary_fingerprint: sha256:162ad29775dcf4498cb64ea72d7d66bc478e9ffcc72e5ecb885b5f26821b2d03
- current_verification_summary_fingerprint: sha256:162ad29775dcf4498cb64ea72d7d66bc478e9ffcc72e5ecb885b5f26821b2d03
- verification_evidence_updated_at: 2026-07-15T23:51:00.969Z
- current_verification_evidence_updated_at: 2026-07-15T23:51:00.969Z
- preferred_order: .vibepro/pr/story-vibepro-guarded-run-session-contract/evidence-reuse.json, .vibepro/pr/story-vibepro-guarded-run-session-contract/decision-index.json, .vibepro/pr/story-vibepro-guarded-run-session-contract/evidence-plan.json, .vibepro/pr/story-vibepro-guarded-run-session-contract/pr-prepare.json

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-15T23:51:00.969Z git_recorded_at=2026-07-15T23:51:00.967Z
- unit: executed_at=2026-07-15T23:50:56.286Z git_recorded_at=2026-07-15T23:50:56.282Z
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-guarded-run-session-contract --stage planning_spec` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-guarded-run-session-contract --base <base-branch>` で次stageへ進む。
...
`vibepro review record . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role product_requirement --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role product_requirement --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role product_requirement --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role architecture_boundary --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role architecture_boundary --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role architecture_boundary --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role spec_consistency --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role spec_consistency --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-guarded-run-session-contract --stage planning_spec --role spec_consistency --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
