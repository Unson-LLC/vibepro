...
- Story: story-vibepro-evidence-adjudication-gate
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 3
- Current head: ce5973465a5ee9f5228067a71b7e208ce784e977
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_e5fae62dfdaf57da2fb7468d5032e11f
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:7f534637804298b3420aed7d1876ace3434505c5c157ffc687f012a2149a4dc9
- current_verification_summary_fingerprint: sha256:7f534637804298b3420aed7d1876ace3434505c5c157ffc687f012a2149a4dc9
- verification_evidence_updated_at: 2026-07-13T12:48:50.059Z
- current_verification_evidence_updated_at: 2026-07-13T12:48:50.059Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-13T12:48:50.059Z git_recorded_at=2026-07-13T12:48:50.051Z
- unit: executed_at=2026-07-13T12:48:47.201Z git_recorded_at=2026-07-13T12:48:47.194Z
- typecheck: executed_at=2026-07-13T12:29:20.759Z git_recorded_at=2026-07-13T12:29:20.749Z
...
Stale reasons:
- head_sha: head_sha changed previous=fb41c4710d95d1ebc525f4b7243d07d2f58556ec current=bde2ddc6431d2c410375dc273d7e57e56cee995c
- spec_fingerprint: spec_fingerprint changed previous=sha256:0ce350255e82eff78c2e412cb1c2ad5b05d7f4cfc36f694dec91551a17b534b8 current=sha256:4f19f4b2a5392d414708bf5c423496f7bccc67761b00dc85d8bb6f0b46ca8857
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:09160cdf7e7db7730105ce2485ddc563048b27c19e49ef6acafa59de98f6c2ef current=sha256:7f534637804298b3420aed7d1876ace3434505c5c157ffc687f012a2149a4dc9
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=- current=2026-07-13T12:48:50.059Z
- verification_command_timestamps: verification_command_timestamps changed previous=[] current=[{"kind":"integration","executed_at":"2026-07-13T12:48:50.059Z","git_recorded_at":"2026-07-13T12:48:50.051Z"},{"kind":"unit","executed_at":"2026-07-13T12:48:47.201Z","git_recorded_at":"2026-07-13T12:48:47.194Z"},{"kind":"typecheck","executed_at":"2026-07-13T12:29:20.759Z","git_recorded_at":"2026-07-13T12:29:20.749Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-evidence-adjudication-gate --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-evidence-adjudication-gate --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-evidence-adjudication-gate/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-evidence-adjudication-gate/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-evidence-adjudication-gate/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-evidence-adjudication-gate/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-evidence-adjudication-gate/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-evidence-adjudication-gate --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-evidence-adjudication-gate --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-evidence-adjudication-gate --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-evidence-adjudication-gate/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-evidence-adjudication-gate --stage gate --role pr_split_scope --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-evidence-adjudication-gate --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-evidence-adjudication-gate --stage gate --role pr_split_scope --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-evidence-adjudication-gate/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-evidence-adjudication-gate --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-evidence-adjudication-gate --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-evidence-adjudication-gate --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
