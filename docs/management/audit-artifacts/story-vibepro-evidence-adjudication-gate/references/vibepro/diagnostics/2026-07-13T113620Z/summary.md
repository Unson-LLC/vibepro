...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-13T113620Z |
| Story | AC証拠の意味的裁定を独立LLM adjudicatorへ委譲するEvidence Adjudication Gateを追加する |
| Story ID | story-vibepro-evidence-adjudication-gate |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.024 (220 edges) | 13(file: 1, node: 92, edge: 220) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
