...
- Story: story-vibepro-surface-aware-agent-review-freshness
- Stage: implementation
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: 2411506a2ffdbe98d28776fcc5af44fd4e823f06
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_aa987acb52576ecd278a5010ffa2f8f9
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:cd351794688a050f5c8a7443865a6cef10480349d7d9ea30b76c0c5cf503d2bd
- current_verification_summary_fingerprint: sha256:41f64a8bf87771fd19017c9dcf87b2d60a6ea608da06ca626bf4c6a10b3494c5
- verification_evidence_updated_at: 2026-07-23T21:46:01.597Z
- current_verification_evidence_updated_at: 2026-07-23T22:10:17.696Z
- preferred_order: -

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-23T21:46:01.597Z git_recorded_at=2026-07-23T21:46:01.574Z
- unit: executed_at=2026-07-23T21:29:45.435Z git_recorded_at=2026-07-23T21:29:45.351Z
- typecheck: executed_at=2026-07-23T17:35:22.521Z git_recorded_at=2026-07-23T17:35:22.471Z

現在のverification command timestamps:
- e2e: executed_at=2026-07-23T22:10:17.696Z git_recorded_at=2026-07-23T22:10:17.650Z
- unit: executed_at=2026-07-23T22:08:24.340Z git_recorded_at=2026-07-23T22:08:24.320Z
- typecheck: executed_at=2026-07-23T17:35:22.521Z git_recorded_at=2026-07-23T17:35:22.471Z

Stale reasons:
- head_sha: review prepare current HEAD does not match evidence key HEAD previous=5ade483c1848edf56c1f0e11782cb616cc3281b2 current=2411506a2ffdbe98d28776fcc5af44fd4e823f06
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:cd351794688a050f5c8a7443865a6cef10480349d7d9ea30b76c0c5cf503d2bd current=sha256:41f64a8bf87771fd19017c9dcf87b2d60a6ea608da06ca626bf4c6a10b3494c5
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-07-23T21:46:01.597Z current=2026-07-23T22:10:17.696Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"e2e","executed_at":"2026-07-23T21:46:01.597Z","git_recorded_at":"2026-07-23T21:46:01.574Z"},{"kind":"unit","executed_at":"2026-07-23T21:29:45.435Z","git_recorded_at":"2026-07-23T21:29:45.351Z"},{"kind":"typecheck","executed_at":"2026-07-23T17:35:22.521Z","git_recorded_at":"2026-07-23T17:35:22.471Z"}] current=[{"kind":"e2e","executed_at":"2026-07-23T22:10:17.696Z","git_recorded_at":"2026-07-23T22:10:17.650Z"},{"kind":"unit","executed_at":"2026-07-23T22:08:24.340Z","git_recorded_at":"2026-07-23T22:08:24.320Z"},{"kind":"typecheck","executed_at":"2026-07-23T17:35:22.521Z","git_recorded_at":"2026-07-23T17:35:22.471Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-surface-aware-agent-review-freshness --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-surface-aware-agent-review-freshness --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-surface-aware-agent-review-freshness/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-surface-aware-agent-review-freshness/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-surface-aware-agent-review-freshness/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-surface-aware-agent-review-freshness/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-surface-aware-agent-review-freshness/implementation/review-request-runtime_contract.md`
...
`vibepro review record . --id story-vibepro-surface-aware-agent-review-freshness --stage implementation --role runtime_contract --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-surface-aware-agent-review-freshness --stage implementation --role runtime_contract --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-surface-aware-agent-review-freshness --stage implementation --role runtime_contract --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-surface-aware-agent-review-freshness --stage implementation --role runtime_contract --agent-id "<replacement-agent-id>" --close-reason "<completed|timeout|replaced|manual_shutdown>" --close-evidence "<replacement-agent-close-evidence>"`
