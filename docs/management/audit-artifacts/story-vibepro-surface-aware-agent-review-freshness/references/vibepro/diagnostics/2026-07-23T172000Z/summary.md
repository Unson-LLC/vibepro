...
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=f763feb2259b dirty=false |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 5203 |
| graphify edges | 11653 |
| 共通スキャン対象 | 7118件 |
...
| 責務混在候補 | 22件 (block: 0件, review: 22件, info: 0件) |
| リファクタリング機会 | 22件 |
| リファクタリングcampaign | 2件 |
| API route | 0件 |
...
- Scenario Gaps: 1
- Contradictions: 0
- Scenario Gap: src/agent-review.js の `!startedEntry?.dispatch_authorization_id` 分岐が、Story/Spec/Architecture/Policyの受け入れ基準または方針で明示されているか確認が必要。
...
- before: 2026-07-23T171342Z / after: 2026-07-23T172000Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0236 (275 edges) | 15(file: 1, node: 110, edge: 273), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
