...
- Current head: 03ac374b7dbf0894ec168ff745bdab07c1be3217
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_d5fe94364568b78478067f8694618c72
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:de9b646860cf0d54a6ffc6206d39396ad4dcc1e1b863d26796d22e03afe2fe04
- current_verification_summary_fingerprint: sha256:7af1892355a517a906ee8e7204436965d33eaa5e207e7f0c9e0285c46d4600e4
- verification_evidence_updated_at: 2026-08-02T19:57:58.530Z
- current_verification_evidence_updated_at: 2026-08-02T20:16:49.053Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-08-02T19:57:57.548Z git_recorded_at=2026-08-02T19:57:58.503Z

現在のverification command timestamps:
- e2e: executed_at=2026-08-02T20:16:48.207Z git_recorded_at=2026-08-02T20:16:49.042Z
- unit: executed_at=2026-08-02T19:57:57.548Z git_recorded_at=2026-08-02T19:57:58.503Z

Stale reasons:
- head_sha: head_sha changed previous=d07cb29027f4b198ae6d07c894ccdf46418ee8dc current=03ac374b7dbf0894ec168ff745bdab07c1be3217
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:de9b646860cf0d54a6ffc6206d39396ad4dcc1e1b863d26796d22e03afe2fe04 current=sha256:7af1892355a517a906ee8e7204436965d33eaa5e207e7f0c9e0285c46d4600e4
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-08-02T19:57:58.530Z current=2026-08-02T20:16:49.053Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"unit","executed_at":"2026-08-02T19:57:57.548Z","git_recorded_at":"2026-08-02T19:57:58.503Z"}] current=[{"kind":"e2e","executed_at":"2026-08-02T20:16:48.207Z","git_recorded_at":"2026-08-02T20:16:49.042Z"},{"kind":"unit","executed_at":"2026-08-02T19:57:57.548Z","git_recorded_at":"2026-08-02T19:57:58.503Z"}]

## Decision Outcome Ledger Summary

- ledger: .vibepro/pr/story-vibepro-codex-host-containment-test-load-tolerance/decision-outcome-ledger.json
- digest: 133ab0082255a2045810199a628179675d2fac9cda4a4978a98b278a5a5c1062
- total: 2
- returned: 2
- omitted: 0
- truncated: false
- partial decision_trace_id=dt_5f2afff5b5605963dd0e4721521b67583a596269591834c881efe541a22e60e7 parent_revision=73e29b51dd84f06873b1f3ea997999458ae4004c2b16295f407728db9785f84f chain={"finding":null,"disposition":null,"decision":null,"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
- partial decision_trace_id=dt_80b832862429508f430379c8057bb99491bd82c69ba341142ee361326a89a7ed parent_revision=b3e4053e34df5d0d59045b66cd887f8409e1adf18877662fea60a1d654d3648f chain={"finding":null,"disposition":null,"decision":null,"behavior_delta":{"status":"not_observed","before":null,"after":null,"change_refs":[],"verification_refs":[],"missing_reason":"explicit_behavior_delta_missing"},"delivery":{"status":"not_delivered","pr":null,"merge":null},"downstream_outcome":{"status":"not_observed","value":null,"reason":null,"source_ref":null,"missing_reason":"observation_missing"}}
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-codex-host-containment-test-load-tolerance --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-codex-host-containment-test-load-tolerance --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-codex-host-containment-test-load-tolerance/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-codex-host-containment-test-load-tolerance/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-codex-host-containment-test-load-tolerance/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-codex-host-containment-test-load-tolerance/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-codex-host-containment-test-load-tolerance/gate/review-request-gate_evidence.md`
...
Review request:
`.vibepro/reviews/story-vibepro-codex-host-containment-test-load-tolerance/gate/review-request-pr_split_scope.md`
...
Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-codex-host-containment-test-load-tolerance --stage gate --role pr_split_scope --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-codex-host-containment-test-load-tolerance --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-codex-host-containment-test-load-tolerance --stage gate --role pr_split_scope --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
...
Review request:
`.vibepro/reviews/story-vibepro-codex-host-containment-test-load-tolerance/gate/review-request-release_risk.md`
...
Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-codex-host-containment-test-load-tolerance --stage gate --role release_risk --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-codex-host-containment-test-load-tolerance --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-codex-host-containment-test-load-tolerance --stage gate --role release_risk --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
