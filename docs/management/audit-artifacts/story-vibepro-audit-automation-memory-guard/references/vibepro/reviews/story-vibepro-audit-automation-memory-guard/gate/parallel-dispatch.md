...
- Story: story-vibepro-audit-automation-memory-guard
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: ccea8bb668539ee9c36df41b4d7bef341348d0d3
- User dirty: false
- Raw dirty: false
...
- status: fresh
- evidence_key: evk_427aab5f40afbf31bc38db3acf3dbb28
- first_input: true
- reason: Fresh evidence summary/index can be used as first review input.
- verification_summary_fingerprint: sha256:ddf505ded939b5e624174aeb7b2553f0689a64ff08a84264360bb01389b1192a
- current_verification_summary_fingerprint: sha256:ddf505ded939b5e624174aeb7b2553f0689a64ff08a84264360bb01389b1192a
- verification_evidence_updated_at: 2026-07-09T15:18:35.639Z
- current_verification_evidence_updated_at: 2026-07-09T15:18:35.639Z
- preferred_order: .vibepro/pr/story-vibepro-audit-automation-memory-guard/evidence-reuse.json, .vibepro/pr/story-vibepro-audit-automation-memory-guard/decision-index.json, .vibepro/pr/story-vibepro-audit-automation-memory-guard/evidence-plan.json, .vibepro/pr/story-vibepro-audit-automation-memory-guard/pr-prepare.json

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-09T15:18:35.639Z git_recorded_at=2026-07-09T15:18:35.638Z
- unit: executed_at=2026-07-09T15:17:07.691Z git_recorded_at=2026-07-09T15:17:07.690Z
- integration: executed_at=2026-07-09T15:14:27.823Z git_recorded_at=2026-07-09T15:14:27.821Z
- typecheck: executed_at=2026-07-09T15:14:12.510Z git_recorded_at=2026-07-09T15:14:12.508Z
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-audit-automation-memory-guard --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-audit-automation-memory-guard --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-audit-automation-memory-guard/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-audit-automation-memory-guard/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-audit-automation-memory-guard/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-audit-automation-memory-guard/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-audit-automation-memory-guard --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-audit-automation-memory-guard --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-audit-automation-memory-guard --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
