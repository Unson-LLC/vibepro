...
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=c9a34976adec dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
- before: 2026-07-09T125602Z / after: 2026-07-09T134318Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0238 (214 edges) | 13(file: 1, node: 89, edge: 214) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
