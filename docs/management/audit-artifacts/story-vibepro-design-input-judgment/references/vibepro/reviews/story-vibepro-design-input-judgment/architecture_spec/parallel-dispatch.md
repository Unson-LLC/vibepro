...
- status: fresh
- evidence_key: evk_dd6a1f1155c98ec5b3355788fc3f6bbe
- first_input: true
...
- preferred_order: .vibepro/pr/story-vibepro-design-input-judgment/evidence-reuse.json, .vibepro/pr/story-vibepro-design-input-judgment/decision-index.json, .vibepro/pr/story-vibepro-design-input-judgment/evidence-plan.json, .vibepro/pr/story-vibepro-design-input-judgment/pr-prepare.json
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-design-input-judgment --stage architecture_spec` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-design-input-judgment --base <base-branch>` で次stageへ進む。
...
`vibepro review record . --id story-vibepro-design-input-judgment --stage architecture_spec --role regression_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-design-input-judgment --stage architecture_spec --role regression_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-design-input-judgment --stage architecture_spec --role regression_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
