...
- Current head: 8aab12a565ec4875446c96a90d3f4cb8336c12fd
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_1bf0d5a53403ec8225bcd1f60ffb14e9
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:c49bea849853eda1a761b16a827bedaf67fa8f78b40521a28dd5803ceaf8c632
- current_verification_summary_fingerprint: sha256:c49bea849853eda1a761b16a827bedaf67fa8f78b40521a28dd5803ceaf8c632
- verification_evidence_updated_at: 2026-07-05T23:08:06.446Z
- current_verification_evidence_updated_at: 2026-07-05T23:08:06.446Z
- preferred_order: -

Reuse key内のverification command timestamps:
- e2e: executed_at=2026-07-05T23:08:06.446Z git_recorded_at=2026-07-05T23:08:06.441Z
- integration: executed_at=2026-07-05T23:07:19.916Z git_recorded_at=2026-07-05T23:07:19.912Z
- unit: executed_at=2026-07-05T22:48:54.204Z git_recorded_at=2026-07-05T22:48:54.203Z
- typecheck: executed_at=2026-07-05T22:48:20.499Z git_recorded_at=2026-07-05T22:48:20.498Z
...
Stale reasons:
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:375afa5b696b82823d36e803a2c748a746797970286e3d42c581468794aaa10b current=sha256:868739deafca832a454dfc5a6dbd28361e9d3e1bc6d35b6ed45fd33db10049b6
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-design-input-judgment --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-design-input-judgment --base <base-branch>` で次stageへ進む。
...
`vibepro review record . --id story-vibepro-design-input-judgment --stage implementation --role runtime_contract --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-design-input-judgment --stage implementation --role runtime_contract --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-design-input-judgment --stage implementation --role runtime_contract --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-design-input-judgment --stage implementation --role ux_completion --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-design-input-judgment --stage implementation --role ux_completion --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-design-input-judgment --stage implementation --role ux_completion --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
