...
| Story | PR Evidence Autopilot |
| Story ID | story-vibepro-pr-evidence-autopilot |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=8a5885ba9424 dirty=false |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0214 (179 edges) | 13(file: 1, node: 79, edge: 179) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
