...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-30T105238Z |
| Story | 製品コードを実行しないtest/e2eの自己充足テストを解消し再発をlintで止める |
| Story ID | story-vibepro-vacuous-e2e-test-elimination |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.2 commit=c6d758363134 dirty=false |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality, api-boundary |
| graphify nodes | 5751 |
| graphify edges | 12909 |
| 共通スキャン対象 | 8379件 |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0216 (279 edges) | 16(file: 1, node: 111, edge: 277), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
