...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-22T030750Z |
| Story | Target Architecture SSOTとconformance dry-runを導入する |
| Story ID | story-vibepro-target-architecture-conformance |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=b0e8a92e290f dirty=false |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4997 |
| graphify edges | 11247 |
| 共通スキャン対象 | 6736件 |
...
- before: 2026-07-22T013133Z / after: 2026-07-22T030750Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0245 (275 edges) | 14(file: 1, node: 111, edge: 275) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
