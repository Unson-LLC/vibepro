...
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=37a83f5e5bb2 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4702 |
| graphify edges | 10541 |
| 共通スキャン対象 | 5510件 |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.021 (221 edges) | 17(file: 1, node: 91, edge: 219), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
