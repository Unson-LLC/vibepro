...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-21T142609Z |
| Story | Story別routing profileとlineage付きprojectionでfeature packetを正本化する |
| Story ID | story-vibepro-routing-profiles-rendered-projections |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=23a31970d51d dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4868 |
| graphify edges | 10974 |
| 共通スキャン対象 | 6134件 |
...
- before: 2026-07-21T103137Z / after: 2026-07-21T142609Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0234 (257 edges) | 13(file: 1, node: 103, edge: 255), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
