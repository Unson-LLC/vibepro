...
- Story: story-vibepro-gate-outcome-roi-ledger
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: da31941ca0159624a205bc074101ee4c9c4ac06c
- User dirty: true
- Raw dirty: true
...
- status: stale
- evidence_key: evk_9c51c9bcf002c1291fb301abed5a7bca
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:8a3f76bcb7a452ec5231c311a02be8903bfb657b7a459811be9dbe247d6b2b3e
- current_verification_summary_fingerprint: sha256:8a4d335ffaa99704ae33437f8b8bc1526bd5995840e6a6581eb7486ca23caa62
- verification_evidence_updated_at: 2026-07-05T08:25:26.172Z
- current_verification_evidence_updated_at: 2026-07-05T08:29:20.590Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-05T08:25:26.172Z git_recorded_at=2026-07-05T08:25:26.164Z

現在のverification command timestamps:
- e2e: executed_at=2026-07-05T08:29:20.590Z git_recorded_at=2026-07-05T08:29:20.581Z
- unit: executed_at=2026-07-05T08:25:26.172Z git_recorded_at=2026-07-05T08:25:26.164Z

Stale reasons:
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:8a3f76bcb7a452ec5231c311a02be8903bfb657b7a459811be9dbe247d6b2b3e current=sha256:8a4d335ffaa99704ae33437f8b8bc1526bd5995840e6a6581eb7486ca23caa62
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-07-05T08:25:26.172Z current=2026-07-05T08:29:20.590Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"unit","executed_at":"2026-07-05T08:25:26.172Z","git_recorded_at":"2026-07-05T08:25:26.164Z"}] current=[{"kind":"e2e","executed_at":"2026-07-05T08:29:20.590Z","git_recorded_at":"2026-07-05T08:29:20.581Z"},{"kind":"unit","executed_at":"2026-07-05T08:25:26.172Z","git_recorded_at":"2026-07-05T08:25:26.164Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-gate-outcome-roi-ledger --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-gate-outcome-roi-ledger --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-gate-outcome-roi-ledger/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-gate-outcome-roi-ledger --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-gate-outcome-roi-ledger --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-gate-outcome-roi-ledger --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
