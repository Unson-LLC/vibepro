...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-03T043747Z |
| Story | Gate evidence classifier normalizes canonical token variants |
| Story ID | story-vibepro-evidence-token-normalization |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=e9a5ed4b5d81 dirty=false |
| 種別 | unknown |
| 描画方式 | - |
...
| graphify edges | 7960 |
| 共通スキャン対象 | 1333件 |
| 秘密情報候補 | 275件 (block: 0件, review: 0件, info: 275件) |
| XSSリスク候補 | 104件 (block: 0件, review: 0件, info: 104件) |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0193 (154 edges) | 15(file: 1, node: 68, edge: 154) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
