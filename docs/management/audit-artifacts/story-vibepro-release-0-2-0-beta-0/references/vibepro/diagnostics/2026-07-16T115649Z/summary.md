...
| Story | VibePro 0.2.0 betaを現在のmainから公開する |
| Story ID | story-vibepro-release-0-2-0-beta-0 |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.0 commit=52633af04ff3 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0227 (221 edges) | 15(file: 1, node: 92, edge: 221) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
