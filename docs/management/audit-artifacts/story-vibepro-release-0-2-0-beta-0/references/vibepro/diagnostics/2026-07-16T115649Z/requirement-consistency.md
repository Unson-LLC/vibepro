...
- REQ-INV-001: package.json と package-lock.json のroot package versionが 0.2.0-beta.0 で一致する。 (story:docs/management/stories/active/story-vibepro-release-0-2-0-beta-0.md)
