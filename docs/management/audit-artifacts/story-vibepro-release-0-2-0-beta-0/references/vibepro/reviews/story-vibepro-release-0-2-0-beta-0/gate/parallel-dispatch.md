...
- Current head: ccaf7de2aea5e1fc3fb4d430eabd206cc155d3e8
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_8c6770471ff1d02958c6884bd5eebb5c
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:b838047daf3a7a3a20347c3493ca5a5087c8eea13770d188e720ca1b8f2d57c7
- current_verification_summary_fingerprint: sha256:b838047daf3a7a3a20347c3493ca5a5087c8eea13770d188e720ca1b8f2d57c7
- verification_evidence_updated_at: 2026-07-16T17:24:00.666Z
- current_verification_evidence_updated_at: 2026-07-16T17:24:00.666Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-07-16T17:24:00.666Z git_recorded_at=2026-07-16T17:24:00.664Z
- unit: executed_at=2026-07-16T17:23:59.766Z git_recorded_at=2026-07-16T17:23:59.764Z
- build: executed_at=2026-07-16T17:23:41.031Z git_recorded_at=2026-07-16T17:23:41.030Z
- typecheck: executed_at=2026-07-16T17:23:39.931Z git_recorded_at=2026-07-16T17:23:39.928Z
...
Stale reasons:
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:e7d575bb849798af2d2101f95ebc74dd8220fa1fa8fb1bf12e297d08b0af7366 current=sha256:b838047daf3a7a3a20347c3493ca5a5087c8eea13770d188e720ca1b8f2d57c7
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-16T17:23:43.057Z current=2026-07-16T17:24:00.666Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"integration","executed_at":"2026-07-16T17:23:43.056Z","git_recorded_at":"2026-07-16T17:23:43.054Z"},{"kind":"unit","executed_at":"2026-07-16T17:23:42.108Z","git_recorded_at":"2026-07-16T17:23:42.106Z"},{"kind":"build","executed_at":"2026-07-16T17:23:41.031Z","git_recorded_at":"2026-07-16T17:23:41.030Z"},{"kind":"typecheck","executed_at":"2026-07-16T17:23:39.931Z","git_recorded_at":"2026-07-16T17:23:39.928Z"}] current=[{"kind":"integration","executed_at":"2026-07-16T17:24:00.666Z","git_recorded_at":"2026-07-16T17:24:00.664Z"},{"kind":"unit","executed_at":"2026-07-16T17:23:59.766Z","git_recorded_at":"2026-07-16T17:23:59.764Z"},{"kind":"build","executed_at":"2026-07-16T17:23:41.031Z","git_recorded_at":"2026-07-16T17:23:41.030Z"},{"kind":"typecheck","executed_at":"2026-07-16T17:23:39.931Z","git_recorded_at":"2026-07-16T17:23:39.928Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-release-0-2-0-beta-0 --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-release-0-2-0-beta-0 --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-release-0-2-0-beta-0/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-release-0-2-0-beta-0/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-release-0-2-0-beta-0/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-release-0-2-0-beta-0/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-release-0-2-0-beta-0/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-release-0-2-0-beta-0/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role pr_split_scope --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role pr_split_scope --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-release-0-2-0-beta-0/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-release-0-2-0-beta-0 --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
