...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-02T233545Z |
| Story | Gate planner scopes stale evidence invalidation by changed surface |
| Story ID | story-vibepro-scoped-evidence-invalidation |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=19315c201ca1 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
| graphify edges | 7949 |
| 共通スキャン対象 | 1292件 |
| 秘密情報候補 | 139件 (block: 0件, review: 0件, info: 139件) |
| XSSリスク候補 | 63件 (block: 0件, review: 0件, info: 63件) |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0194 (154 edges) | 13(file: 1, node: 68, edge: 154) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
