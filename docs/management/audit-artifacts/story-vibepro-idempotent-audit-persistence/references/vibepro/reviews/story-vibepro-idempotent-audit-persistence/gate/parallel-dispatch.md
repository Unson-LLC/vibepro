...
- Story: story-vibepro-idempotent-audit-persistence
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 1
- Current head: ca76367c6dce46cb34156d10947a94eeb9c0c402
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_fc173a42450981393dd06330f30bd454
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:932c4f17bf14e0123efeaf686cad320cca526f26b5dbd28f4c4a945e875044a4
- current_verification_summary_fingerprint: sha256:932c4f17bf14e0123efeaf686cad320cca526f26b5dbd28f4c4a945e875044a4
- verification_evidence_updated_at: 2026-07-08T06:15:51.112Z
- current_verification_evidence_updated_at: 2026-07-08T06:15:51.112Z
- preferred_order: -

Reuse key内のverification command timestamps:
- build: executed_at=2026-07-08T06:15:51.112Z git_recorded_at=2026-07-08T06:15:51.071Z
- integration: executed_at=2026-07-08T06:15:13.615Z git_recorded_at=2026-07-08T06:15:13.528Z
- typecheck: executed_at=2026-07-08T06:15:06.826Z git_recorded_at=2026-07-08T06:15:06.793Z
- e2e: executed_at=2026-07-08T06:15:01.721Z git_recorded_at=2026-07-08T06:15:01.683Z
- unit: executed_at=2026-07-08T06:14:56.711Z git_recorded_at=2026-07-08T06:14:56.618Z
...
Stale reasons:
- head_sha: head_sha changed previous=0e21970f71d92254d6dd009998432443bff9dbc2 current=ca76367c6dce46cb34156d10947a94eeb9c0c402
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:e4b30d048772b1299f95d8e18457d0d05c17d718dfa1938a79cedf6c1c95d3bc current=sha256:623b2300702b162089db65f9b63a3ea5674f451e36771a4afc3574aeb5e99c6d
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-idempotent-audit-persistence --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-idempotent-audit-persistence --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-idempotent-audit-persistence/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-idempotent-audit-persistence --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-idempotent-audit-persistence --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-idempotent-audit-persistence --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
