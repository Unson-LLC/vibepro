...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-12T020147Z |
| Story | Session exposure provenance and digest deduplication |
| Story ID | story-vibepro-session-exposure-provenance-dedup |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=9ab79560e5db dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0242 (220 edges) | 12(file: 1, node: 92, edge: 220) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
