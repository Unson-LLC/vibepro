...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-21T084008Z |
| Story | Session cost attributionを構造的なworktree境界に限定する |
| Story ID | story-vibepro-session-attribution-boundary-guard |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=d0697800b4e3 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4799 |
| graphify edges | 10806 |
| 共通スキャン対象 | 5908件 |
...
- before: 2026-07-18T041235Z / after: 2026-07-21T084008Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0221 (239 edges) | 15(file: 1, node: 99, edge: 239) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
