...
- status: stale
- evidence_key: evk_e9c3f4442c982934e8976f4e7407c1f3
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:16e3c31a7ea77185c04dc42ac71af87fb501784421cca65b9d8daac94a90667f
- current_verification_summary_fingerprint: sha256:16e3c31a7ea77185c04dc42ac71af87fb501784421cca65b9d8daac94a90667f
- verification_evidence_updated_at: 2026-07-22T12:59:58.467Z
- current_verification_evidence_updated_at: 2026-07-22T12:59:58.467Z
- preferred_order: -
...
Stale reasons:
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:c0ddffdc996c05e26e5506320ea2deff7544d7bff2779dc16223cb99e9cd2712 current=sha256:16e3c31a7ea77185c04dc42ac71af87fb501784421cca65b9d8daac94a90667f
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-22T12:55:32.910Z current=2026-07-22T12:59:58.467Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"unit","executed_at":"2026-07-22T12:55:32.910Z","git_recorded_at":"2026-07-22T12:55:32.893Z"},{"kind":"e2e","executed_at":"2026-07-22T12:53:43.008Z","git_recorded_at":"2026-07-22T12:53:42.990Z"},{"kind":"integration","executed_at":"2026-07-22T12:52:18.718Z","git_recorded_at":"2026-07-22T12:52:18.711Z"}] current=[{"kind":"e2e","executed_at":"2026-07-22T12:59:58.467Z","git_recorded_at":"2026-07-22T12:59:58.439Z"},{"kind":"unit","executed_at":"2026-07-22T12:55:32.910Z","git_recorded_at":"2026-07-22T12:55:32.893Z"},{"kind":"integration","executed_at":"2026-07-22T12:52:18.718Z","git_recorded_at":"2026-07-22T12:52:18.711Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:92800244d14d82c6d1a4e70d61e63ae3d617c4777d87dc083b0aee7511a87ea2 current=sha256:7a25e809c41e30a509ee6cee691e0b8e84b4bc6de321999c7d8bf032c1e54450
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-independent-review-orchestration --stage implementation` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-independent-review-orchestration --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-independent-review-orchestration/implementation/review-request-runtime_contract.md`
...
`vibepro review record . --id story-vibepro-independent-review-orchestration --stage implementation --role runtime_contract --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-independent-review-orchestration --stage implementation --role runtime_contract --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-independent-review-orchestration --stage implementation --role runtime_contract --agent-system <codex|claude_code> --agent-id "<subagent-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-independent-review-orchestration --stage implementation --role runtime_contract --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
