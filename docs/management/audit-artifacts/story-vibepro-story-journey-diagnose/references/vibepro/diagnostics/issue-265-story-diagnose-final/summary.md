...
| Story | Story診断でJourney未整理を見落とさない |
| Story ID | story-vibepro-story-journey-diagnose |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=df25e940e997 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
- before: issue-265-story-diagnose / after: issue-265-story-diagnose-final
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0191 (154 edges) | 16(file: 1, node: 68, edge: 154) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
