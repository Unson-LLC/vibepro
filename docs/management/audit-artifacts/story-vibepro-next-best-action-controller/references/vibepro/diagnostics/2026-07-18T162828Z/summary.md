...
| Story | 期待価値で次の一手を選ぶMeta Controller |
| Story ID | story-vibepro-next-best-action-controller |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.2.0-beta.0 commit=d31f543b3c9a dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0224 (221 edges) | 15(file: 1, node: 91, edge: 219), 1(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
