...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-14T045619Z |
| Story | 判断DAGの各項目を独立LLM judgeにチェックリスト裁定させる |
| Story ID | story-vibepro-judgment-dag-adjudication |
| 診断フェーズ | design_input |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=b6a807417ea9 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0238 (220 edges) | 14(file: 1, node: 91, edge: 218), 2(file: 1, node: 1, edge: 8) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
