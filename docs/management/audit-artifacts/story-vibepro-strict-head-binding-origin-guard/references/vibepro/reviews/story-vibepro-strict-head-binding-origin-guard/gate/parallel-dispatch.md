...
- status: stale
- evidence_key: evk_5f4ee99c2d3a7081eaae4c0d6893aaba
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:ab959bd872971df65c6b5847bea5302fed975b09ef11bdf5144f4b15f330f7c1
- current_verification_summary_fingerprint: sha256:0b0e0c63e43148baf89a5085ffbf6ad021f551ab64d58481399932690fe921ec
- verification_evidence_updated_at: 2026-08-03T12:00:15.135Z
- current_verification_evidence_updated_at: 2026-08-03T12:09:00.509Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-08-03T12:00:14.217Z git_recorded_at=2026-08-03T12:00:15.129Z
- e2e: executed_at=2026-08-03T11:27:04.444Z git_recorded_at=2026-08-03T11:27:05.239Z
...
Stale reasons:
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:ab959bd872971df65c6b5847bea5302fed975b09ef11bdf5144f4b15f330f7c1 current=sha256:0b0e0c63e43148baf89a5085ffbf6ad021f551ab64d58481399932690fe921ec
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-08-03T12:00:15.135Z current=2026-08-03T12:09:00.509Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"unit","executed_at":"2026-08-03T12:00:14.217Z","git_recorded_at":"2026-08-03T12:00:15.129Z"},{"kind":"e2e","executed_at":"2026-08-03T11:27:04.444Z","git_recorded_at":"2026-08-03T11:27:05.239Z"}] current=[{"kind":"integration","executed_at":"2026-08-03T12:08:59.838Z","git_recorded_at":"2026-08-03T12:09:00.490Z"},{"kind":"typecheck","executed_at":"2026-08-03T12:08:39.044Z","git_recorded_at":"2026-08-03T12:08:39.668Z"},{"kind":"e2e","executed_at":"2026-08-03T12:08:13.955Z","git_recorded_at":"2026-08-03T12:08:14.649Z"},{"kind":"unit","executed_at":"2026-08-03T12:00:14.217Z","git_recorded_at":"2026-08-03T12:00:15.129Z"}]
...
- digest: 83f4b734d290ef9793c103af8c9785d85fbd4094442eb43a948019a06d270a91
- total: 0
- returned: 0
- omitted: 0
- truncated: false
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-strict-head-binding-origin-guard --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-strict-head-binding-origin-guard --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-strict-head-binding-origin-guard/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-strict-head-binding-origin-guard --stage gate --role gate_evidence --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-strict-head-binding-origin-guard --stage gate --role gate_evidence --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-strict-head-binding-origin-guard --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-strict-head-binding-origin-guard --stage gate --role gate_evidence --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
...
Review request:
`.vibepro/reviews/story-vibepro-strict-head-binding-origin-guard/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-strict-head-binding-origin-guard --stage gate --role release_risk --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-strict-head-binding-origin-guard --stage gate --role release_risk --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-strict-head-binding-origin-guard --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-strict-head-binding-origin-guard --stage gate --role release_risk --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
