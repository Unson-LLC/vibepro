...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-24T223043Z |
| Story | モジュール間依存の測定をGraphify callsから実import文スキャンへ切り替える |
| Story ID | story-vibepro-import-based-conformance |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=2d255f2505e4 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality, api-boundary |
| graphify nodes | 5386 |
| graphify edges | 12068 |
| 共通スキャン対象 | 7843件 |
