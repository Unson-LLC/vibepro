...
- Current head: b36d1ee1e0f0454707f9bd7ac4cd763ef13a46a5
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_c0b68a71089bec4cbae58b2da1d038e6
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:7a213ca7e69412cddc65a7f11d4e6f1cfbe8be3d5325077b8e47319b6707ea21
- current_verification_summary_fingerprint: sha256:7a213ca7e69412cddc65a7f11d4e6f1cfbe8be3d5325077b8e47319b6707ea21
- verification_evidence_updated_at: 2026-07-24T15:31:42.124Z
- current_verification_evidence_updated_at: 2026-07-24T15:31:42.124Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-24T15:31:42.124Z git_recorded_at=2026-07-24T15:31:42.096Z
- e2e: executed_at=2026-07-24T15:26:45.423Z git_recorded_at=2026-07-24T15:26:45.399Z
...
Stale reasons:
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:ef40584eb5db31f7b9c4d644c4c81c92e6a247eda19b3bac4e9cac451fbf18fb current=sha256:7a213ca7e69412cddc65a7f11d4e6f1cfbe8be3d5325077b8e47319b6707ea21
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-24T15:26:45.423Z current=2026-07-24T15:31:42.124Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"e2e","executed_at":"2026-07-24T15:26:45.423Z","git_recorded_at":"2026-07-24T15:26:45.399Z"},{"kind":"unit","executed_at":"2026-07-24T15:18:07.061Z","git_recorded_at":"2026-07-24T15:18:07.032Z"}] current=[{"kind":"unit","executed_at":"2026-07-24T15:31:42.124Z","git_recorded_at":"2026-07-24T15:31:42.096Z"},{"kind":"e2e","executed_at":"2026-07-24T15:26:45.423Z","git_recorded_at":"2026-07-24T15:26:45.399Z"}]
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-infra-story-dependency-cut --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-infra-story-dependency-cut --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-infra-story-dependency-cut/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-infra-story-dependency-cut/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-infra-story-dependency-cut/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-infra-story-dependency-cut/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-infra-story-dependency-cut/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-infra-story-dependency-cut --stage gate --role gate_evidence --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-infra-story-dependency-cut --stage gate --role gate_evidence --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-infra-story-dependency-cut --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-infra-story-dependency-cut --stage gate --role gate_evidence --agent-id "<replacement-agent-id>" --close-reason "<completed|timeout|replaced|manual_shutdown>" --close-evidence "<replacement-agent-close-evidence>"`
