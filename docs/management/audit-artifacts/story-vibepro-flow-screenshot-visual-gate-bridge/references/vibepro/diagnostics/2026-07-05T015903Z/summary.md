...
| Story | verify flow のスクリーンショットを Visual QA Gate に自動接続する |
| Story ID | story-vibepro-flow-screenshot-visual-gate-bridge |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=fe551a62d3b5 dirty=false |
| 種別 | unknown |
| 描画方式 | - |
...
| graphify edges | 8165 |
| 共通スキャン対象 | 1530件 |
| 秘密情報候補 | 1091件 (block: 0件, review: 0件, info: 1091件) |
| XSSリスク候補 | 219件 (block: 0件, review: 0件, info: 219件) |
...
- before: 2026-07-04T235435Z / after: 2026-07-05T015903Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0219 (179 edges) | 14(file: 1, node: 79, edge: 179) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
