...
- Story: story-vibepro-meeting-minutes-editor-prompt
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 3
- Current head: b7e685c7963243ac6163c9fa07ec0df1c785ea0f
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_794e3893faed2bab9d971ce34511cc68
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:8be387df16acc2efb1d5d4ab337cee5d1a6514131bba9d393aaf10683ec9ea68
- current_verification_summary_fingerprint: sha256:8be387df16acc2efb1d5d4ab337cee5d1a6514131bba9d393aaf10683ec9ea68
- verification_evidence_updated_at: 2026-06-30T06:28:18.662Z
- current_verification_evidence_updated_at: 2026-06-30T06:28:18.662Z
- preferred_order: -

Reuse key内のverification command timestamps:
- integration: executed_at=2026-06-30T06:28:18.662Z git_recorded_at=2026-06-30T06:28:18.661Z
- build: executed_at=2026-06-30T06:28:17.132Z git_recorded_at=2026-06-30T06:28:17.131Z
- typecheck: executed_at=2026-06-30T06:28:16.325Z git_recorded_at=2026-06-30T06:28:16.310Z
- unit: executed_at=2026-06-30T06:28:15.528Z git_recorded_at=2026-06-30T06:28:15.527Z
...
Stale reasons:
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:188577e24142a0b6dfacf2d722158b7836cf9ed921c46c12e74f14ebef2cec96 current=sha256:8be387df16acc2efb1d5d4ab337cee5d1a6514131bba9d393aaf10683ec9ea68
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-06-30T06:13:03.173Z current=2026-06-30T06:28:18.662Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"unit","executed_at":"2026-06-30T06:13:03.173Z","git_recorded_at":"2026-06-30T06:13:03.172Z"},{"kind":"integration","executed_at":"2026-06-30T06:06:04.503Z","git_recorded_at":"2026-06-30T06:06:04.500Z"},{"kind":"build","executed_at":"2026-06-30T05:58:20.937Z","git_recorded_at":"2026-06-30T05:58:20.937Z"},{"kind":"typecheck","executed_at":"2026-06-30T05:58:20.366Z","git_recorded_at":"2026-06-30T05:58:20.365Z"}] current=[{"kind":"integration","executed_at":"2026-06-30T06:28:18.662Z","git_recorded_at":"2026-06-30T06:28:18.661Z"},{"kind":"build","executed_at":"2026-06-30T06:28:17.132Z","git_recorded_at":"2026-06-30T06:28:17.131Z"},{"kind":"typecheck","executed_at":"2026-06-30T06:28:16.325Z","git_recorded_at":"2026-06-30T06:28:16.310Z"},{"kind":"unit","executed_at":"2026-06-30T06:28:15.528Z","git_recorded_at":"2026-06-30T06:28:15.527Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:7e4b6e154ff48930e81977732a633809299ddd4235a2ff2d80e1395de1795b37 current=sha256:37383ece8bd31145a6b250035e241c5d1223022f7fa1027ece6bc2a3e5c70fd4
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-meeting-minutes-editor-prompt --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-meeting-minutes-editor-prompt --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-meeting-minutes-editor-prompt/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-meeting-minutes-editor-prompt/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role pr_split_scope --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role pr_split_scope --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-meeting-minutes-editor-prompt/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-meeting-minutes-editor-prompt --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
