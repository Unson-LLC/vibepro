...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-07-04T210748Z |
| Story | Focused PR readiness views stay lightweight |
| Story ID | story-vibepro-gate-efficiency-fast-readiness |
| VibePro Runtime | vibepro@0.1.0-beta.0 commit=3264a2256778 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0221 (179 edges) | 13(file: 1, node: 79, edge: 179) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
