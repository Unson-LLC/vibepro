...
| 項目 | 内容 |
|------|------|
| Run ID | 2026-08-03T033601Z |
| Story | 死んだ人間向けPRサマリーレンダラーチェーンを削除する |
| Story ID | story-vibepro-pr-human-summary-dead-chain-removal |
| 診断フェーズ | pre_implementation |
| VibePro Runtime | vibepro@0.2.0-beta.2 commit=ff39480d2766 dirty=true |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality, api-boundary |
| graphify nodes | 5896 |
| graphify edges | 13138 |
| 共通スキャン対象 | 9313件 |
...
- before: 2026-08-03T033000Z / after: 2026-08-03T033601Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.0212 (279 edges) | 18(file: 1, node: 112, edge: 279) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
