...
- status: stale
- evidence_key: evk_90671e83b947f86bbdb13c23a89d1276
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:abcf446ee43a1bab57f68418658f63c5c3af4d6cf32545a2299ac51a4584c130
- current_verification_summary_fingerprint: sha256:038679787939bf6fed0a2a8ba8501945fc361ef064fad290ee85f0baab4067b4
- verification_evidence_updated_at: 2026-08-03T06:56:58.983Z
- current_verification_evidence_updated_at: 2026-08-03T07:45:13.284Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-08-03T06:56:58.103Z git_recorded_at=2026-08-03T06:56:58.972Z
- e2e: executed_at=2026-08-03T05:53:54.586Z git_recorded_at=2026-08-03T05:53:55.812Z
- integration: executed_at=2026-08-03T05:53:13.097Z git_recorded_at=2026-08-03T05:53:14.830Z
- typecheck: executed_at=2026-08-03T05:52:04.643Z git_recorded_at=2026-08-03T05:52:05.752Z
...
Stale reasons:
- head_sha: head_sha changed previous=72a4508ec3437bcbbfd2bc2656337d916a32d4c2 current=f44165f2c03c9ee832e4b468c44705ea06738c43
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:31ca49a39f2feae04a05e1c28dd1494ba4a74bb16933af8916219eb93ec731b7 current=sha256:71be3c541dc3602147657520e4c8c6421f1b56b3163ffb13acd9a7cf43020188
- verification_summary_fingerprint: review prepare current verification_summary_fingerprint does not match evidence key input previous=sha256:abcf446ee43a1bab57f68418658f63c5c3af4d6cf32545a2299ac51a4584c130 current=sha256:038679787939bf6fed0a2a8ba8501945fc361ef064fad290ee85f0baab4067b4
- verification_evidence_updated_at: review prepare current verification_evidence_updated_at does not match evidence key input previous=2026-08-03T06:56:58.983Z current=2026-08-03T07:45:13.284Z
- verification_command_timestamps: review prepare current verification_command_timestamps does not match evidence key input previous=[{"kind":"unit","executed_at":"2026-08-03T06:56:58.103Z","git_recorded_at":"2026-08-03T06:56:58.972Z"},{"kind":"e2e","executed_at":"2026-08-03T05:53:54.586Z","git_recorded_at":"2026-08-03T05:53:55.812Z"},{"kind":"integration","executed_at":"2026-08-03T05:53:13.097Z","git_recorded_at":"2026-08-03T05:53:14.830Z"},{"kind":"typecheck","executed_at":"2026-08-03T05:52:04.643Z","git_recorded_at":"2026-08-03T05:52:05.752Z"}] current=[{"kind":"unit","executed_at":"2026-08-03T07:45:12.362Z","git_recorded_at":"2026-08-03T07:45:13.275Z"},{"kind":"integration","executed_at":"2026-08-03T07:02:04.546Z","git_recorded_at":"2026-08-03T07:02:05.420Z"},{"kind":"e2e","executed_at":"2026-08-03T07:01:15.897Z","git_recorded_at":"2026-08-03T07:01:16.644Z"},{"kind":"typecheck","executed_at":"2026-08-03T07:00:53.834Z","git_recorded_at":"2026-08-03T07:00:54.949Z"}]
...
- digest: a0fd680dd7690093331a007b3279471503dc039e17c82bd722255a655ba6a4c6
- total: 2
- returned: 2
- omitted: 0
- truncated: false
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-pr-human-summary-dead-chain-removal --base <base-branch>` で次stageへ進む。
...
Review request:
`.vibepro/reviews/story-vibepro-pr-human-summary-dead-chain-removal/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role gate_evidence --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role gate_evidence --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role gate_evidence --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
...
Review request:
`.vibepro/reviews/story-vibepro-pr-human-summary-dead-chain-removal/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role pr_split_scope --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role pr_split_scope --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role pr_split_scope --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
...
Review request:
`.vibepro/reviews/story-vibepro-pr-human-summary-dead-chain-removal/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role release_risk --status "<pass|needs_changes|block>" --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence "<inspection-evidence>" --inspection-input "<ref>" --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system "<codex|claude_code>" --execution-mode parallel_subagent --agent-id "<replacement-agent-id>" --agent-thread-id "<replacement-agent-thread-id>" --agent-session-id "<replacement-agent-session-id>" --implementation-session-id "<implementation-session-id>" --reviewer-identity separate_session --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript "<replacement-agent-transcript>" --agent-closed --agent-close-evidence "<replacement-agent-close-evidence>"`

Dispatch authorization command（spawn前に実行し、actionがdispatchでなければspawnしない）:
`vibepro review authorize . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role release_risk --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-pr-human-summary-dead-chain-removal --stage gate --role release_risk --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
