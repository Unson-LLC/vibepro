...
| VibePro Runtime | vibepro@0.2.0-beta.1 commit=be8236faf7be dirty=false |
| 種別 | unknown |
| 描画方式 | - |
| 適用チェック | secrets, xss, dependency-graph, code-quality |
| graphify nodes | 4515 |
| graphify edges | 10037 |
| 共通スキャン対象 | 5008件 |
...
- before: 2026-07-19T032731Z / after: 2026-07-19T032804Z
...
|----|------------------|------|------|--------|-----------|------------|------|
| VP-ACTION-ARCH-001 | VP-ARCH-001 | responsibility split campaignをStory化する | 1件 | 0.022 (221 edges) | 15(file: 1, node: 92, edge: 221) | src/session-efficiency-audit.js<br>src/cli.js<br>src/workspace.js | proposal_only / mutates_repository=false |
