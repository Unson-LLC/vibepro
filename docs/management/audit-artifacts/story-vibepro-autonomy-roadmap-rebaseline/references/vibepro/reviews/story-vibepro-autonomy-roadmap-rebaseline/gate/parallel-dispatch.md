...
- Story: story-vibepro-autonomy-roadmap-rebaseline
- Stage: gate
- Mode: policy-aware parallel review dispatch
- Required subagents: 3
- Current head: e096fdb300a610e185f596dd2530dfcbe6605594
- User dirty: false
- Raw dirty: false
...
- status: stale
- evidence_key: evk_0e91b77f1031a6783686cf142b0e7513
- first_input: false
- reason: Evidence reuse artifact is not fresh for the current review context.
- verification_summary_fingerprint: sha256:1d1b6b2b05930c55753d0617bbbae3347a60c703369175919398c9ffc73978e1
- current_verification_summary_fingerprint: sha256:1d1b6b2b05930c55753d0617bbbae3347a60c703369175919398c9ffc73978e1
- verification_evidence_updated_at: 2026-07-18T03:03:54.970Z
- current_verification_evidence_updated_at: 2026-07-18T03:03:54.970Z
- preferred_order: -

Reuse key内のverification command timestamps:
- unit: executed_at=2026-07-18T03:03:54.970Z git_recorded_at=2026-07-18T03:03:54.968Z
- integration: executed_at=2026-07-18T03:02:22.362Z git_recorded_at=2026-07-18T03:02:22.362Z
...
Stale reasons:
- head_sha: head_sha changed previous=85647ea00a51828a8e2876c03849f76f7e4a2c14 current=e096fdb300a610e185f596dd2530dfcbe6605594
- verification_summary_fingerprint: verification_summary_fingerprint changed previous=sha256:7171b71ed07927f719bb1298e8243677406e69ecb2fae65dee5e7dc18fa6c515 current=sha256:1d1b6b2b05930c55753d0617bbbae3347a60c703369175919398c9ffc73978e1
- verification_evidence_updated_at: verification_evidence_updated_at changed previous=2026-07-18T03:02:22.362Z current=2026-07-18T03:03:54.970Z
- verification_command_timestamps: verification_command_timestamps changed previous=[{"kind":"integration","executed_at":"2026-07-18T03:02:22.362Z","git_recorded_at":"2026-07-18T03:02:22.362Z"},{"kind":"unit","executed_at":"2026-07-18T01:49:30.687Z","git_recorded_at":"2026-07-18T01:49:30.686Z"}] current=[{"kind":"unit","executed_at":"2026-07-18T03:03:54.970Z","git_recorded_at":"2026-07-18T03:03:54.968Z"},{"kind":"integration","executed_at":"2026-07-18T03:02:22.362Z","git_recorded_at":"2026-07-18T03:02:22.362Z"}]
- risk_surface_fingerprint: risk_surface_fingerprint changed previous=sha256:8fcbc49bec5cc949fceb179b0f77aa92e1a5e10214bba1b6c5df359bf80ae4bb current=sha256:efec0cdce69ef2c156562722db710c364971d077f4b0d52a69fbf3f989ab1f7b
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate` を実行し、その後 `vibepro pr prepare . --story-id story-vibepro-autonomy-roadmap-rebaseline --base <base-branch>` で次stageへ進む。
...
- `.vibepro/pr/story-vibepro-autonomy-roadmap-rebaseline/decision-index.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-index.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-autonomy-roadmap-rebaseline/design-ssot-reconciliation.summary.json`（bounded summary。まずこれを読む）。full artifact `design-ssot-reconciliation.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-autonomy-roadmap-rebaseline/senior-gap-judgment.summary.json`（bounded summary。まずこれを読む）。full artifact `senior-gap-judgment.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-autonomy-roadmap-rebaseline/ref-topology.summary.json`（bounded summary。まずこれを読む）。full artifact `ref-topology.json` は必要な深掘り時のみ開く。
- `.vibepro/pr/story-vibepro-autonomy-roadmap-rebaseline/decision-records.summary.json`（bounded summary。まずこれを読む）。full artifact `decision-records.json` は必要な深掘り時のみ開く。
...
Review request:
`.vibepro/reviews/story-vibepro-autonomy-roadmap-rebaseline/gate/review-request-gate_evidence.md`
...
`vibepro review record . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role gate_evidence --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role gate_evidence --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role gate_evidence --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-autonomy-roadmap-rebaseline/gate/review-request-pr_split_scope.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role pr_split_scope --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role pr_split_scope --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role pr_split_scope --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
...
Review request:
`.vibepro/reviews/story-vibepro-autonomy-roadmap-rebaseline/gate/review-request-release_risk.md`
...
subagentの結果受領後に記録するcommand:
`vibepro review record . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role release_risk --status <pass|needs_changes|block> --summary "<summary>" --inspection-summary "<inspection-summary>" --inspection-evidence <inspection-evidence> --inspection-input <ref> --judgment-delta "<initial judgment -> final judgment because evidence>" --agent-system <codex|claude_code> --execution-mode parallel_subagent --agent-id "<subagent-id>" --agent-model "<model>" --agent-reasoning-effort "<reasoning-effort>" --agent-cost-tier "<cost-tier>" --agent-transcript <artifact> --agent-closed`

Lifecycle start command:
`vibepro review start . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role release_risk --agent-system <codex|claude_code> --agent-id "<subagent-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id story-vibepro-autonomy-roadmap-rebaseline --stage gate --role release_risk --agent-id "<subagent-id>" --close-reason <completed|timeout|replaced|manual_shutdown>`
