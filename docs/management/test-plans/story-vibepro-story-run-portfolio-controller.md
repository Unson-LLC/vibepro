...
| Orphaned recovery mutex exposes typed owner evidence and repair action instead of permanent busy | Portfolio recovery-mutex focused test |
...
| Malformed or authority-invalid Run candidate blocks exact-once lookup with artifact evidence | Guarded Run creation-request corruption focused test |
