...
test('trusted delivery efficiency guardrail replays TDEG-S-1 through TDEG-S-12', async () => {
  ...
  assert.match(result.stdout, /(?:#|ℹ) fail 0\b/, 'TDEG-S-12 preserves the focused contract matrix');
  const scenarios = [
